	...
	.file	"llvm-link"
	.file	1 "/workspaces/llvmta/testcases/singletest" "iir/iir.c"
	.globl	iir_init                        @ -- Begin function iir_init
	.p2align	2
	.type	iir_init,%function
	.code	32                              @ @iir_init
iir_init:
.Lfunc_begin0:
	.loc	1 75 0                          @ iir/iir.c:75:0
	.fnstart
...
.Ltmp0:
	.loc	1 79 17 prologue_end            @ iir/iir.c:79:17
	strb	r0, [sp, #3]
.Ltmp1:
	@DEBUG_VALUE: iir_init:f <- 0
	@DEBUG_VALUE: iir_init:f <- [DW_OP_consts 4, DW_OP_div, DW_OP_stack_value] $r0
	.loc	1 83 3                          @ iir/iir.c:83:3
	cmp	r0, #80
	beq	.LBB0_2
.Ltmp2:
.LBB0_1:                                @ %for.body
	...
	@DEBUG_VALUE: iir_init:f <- [DW_OP_consts 4, DW_OP_div, DW_OP_stack_value] $r0
	.loc	1 84 27                         @ iir/iir.c:84:27
	str	r2, [r1, r0]
.Ltmp3:
	@DEBUG_VALUE: iir_init:f <- [DW_OP_consts 4, DW_OP_div, DW_OP_consts 1, DW_OP_plus, DW_OP_stack_value] $r0
	.loc	1 83 3                          @ iir/iir.c:83:3
	add	r0, r0, #4
.Ltmp4:
	@DEBUG_VALUE: iir_init:f <- [DW_OP_consts 4, DW_OP_div, DW_OP_stack_value] $r0
	.loc	1 83 3 is_stmt 0                @ iir/iir.c:83:3
	cmp	r0, #80
	bne	.LBB0_1
.Ltmp5:
.LBB0_2:                                @ %for.end
	@DEBUG_VALUE: iir_init:f <- [DW_OP_consts 4, DW_OP_div, DW_OP_stack_value] $r0
	.loc	1 0 3                           @ iir/iir.c:0:3
	ldr	r12, .LCPI0_1
	mov	r2, #0
.Ltmp6:
	@DEBUG_VALUE: iir_init:f <- 0
	mov	r3, #0
.Ltmp7:
	@DEBUG_VALUE: iir_init:f <- [DW_OP_consts 4, DW_OP_div, DW_OP_stack_value] $r3
	.loc	1 87 3 is_stmt 1                @ iir/iir.c:87:3
	cmp	r3, #32
	beq	.LBB0_4
.Ltmp8:
.LBB0_3:                                @ %for.body3
                                        @ =>This Inner Loop Header: Depth=1
	@DEBUG_VALUE: iir_init:f <- [DW_OP_consts 4, DW_OP_div, DW_OP_stack_value] $r3
	.loc	1 88 17                         @ iir/iir.c:88:17
	str	r2, [r12, r3]
.Ltmp9:
	@DEBUG_VALUE: iir_init:f <- [DW_OP_consts 4, DW_OP_div, DW_OP_consts 1, DW_OP_plus, DW_OP_stack_value] $r3
	.loc	1 87 3                          @ iir/iir.c:87:3
	add	r3, r3, #4
.Ltmp10:
	@DEBUG_VALUE: iir_init:f <- [DW_OP_consts 4, DW_OP_div, DW_OP_stack_value] $r3
	.loc	1 87 3 is_stmt 0                @ iir/iir.c:87:3
	cmp	r3, #32
	bne	.LBB0_3
.Ltmp11:
.LBB0_4:                                @ %for.end7
	@DEBUG_VALUE: iir_init:f <- [DW_OP_consts 4, DW_OP_div, DW_OP_stack_value] $r3
	.loc	1 90 9 is_stmt 1                @ iir/iir.c:90:9
	ldr	r2, .LCPI0_2
	mov	r3, #1065353216
.Ltmp12:
	str	r3, [r2]
	mov	r2, #0
.Ltmp13:
	@DEBUG_VALUE: iir_init:p <- undef
	@DEBUG_VALUE: iir_init:i <- 0
	@DEBUG_VALUE: iir_init:i <- $r2
	.loc	1 97 3                          @ iir/iir.c:97:3
	cmp	r2, #80
	beq	.LBB0_6
.Ltmp14:
.LBB0_5:                                @ %for.body10
                                        @ =>This Inner Loop Header: Depth=1
	@DEBUG_VALUE: iir_init:i <- $r2
	.loc	1 98 8                          @ iir/iir.c:98:8
	ldrb	r3, [r1, r2]
	.loc	1 98 11 is_stmt 0               @ iir/iir.c:98:11
	ldrb	r0, [sp, #3]
	.loc	1 98 8                          @ iir/iir.c:98:8
	eor	r0, r3, r0
	strb	r0, [r1, r2]
	.loc	1 97 48 is_stmt 1               @ iir/iir.c:97:48
	add	r2, r2, #1
.Ltmp15:
	@DEBUG_VALUE: iir_init:i <- $r2
	@DEBUG_VALUE: iir_init:i <- $r2
	.loc	1 97 3 is_stmt 0                @ iir/iir.c:97:3
	cmp	r2, #80
	bne	.LBB0_5
.Ltmp16:
.LBB0_6:                                @ %for.end15
...
.LBB0_7:                                @ %for.cond16
                                        @ =>This Inner Loop Header: Depth=1
	@DEBUG_VALUE: iir_init:i <- $r1
	@DEBUG_VALUE: iir_init:p <- [DW_OP_LLVM_arg 0, DW_OP_LLVM_arg 0, DW_OP_plus, DW_OP_stack_value] undef
	.loc	1 102 3 is_stmt 1               @ iir/iir.c:102:3
	cmp	r1, #32
.Ltmp18:
	.loc	1 104 1                         @ iir/iir.c:104:1
	addeq	sp, sp, #4
	bxeq	lr
.Ltmp19:
.LBB0_8:                                @ %for.body19
	...
	@DEBUG_VALUE: iir_init:i <- $r1
	.loc	1 103 8                         @ iir/iir.c:103:8
	ldrb	r0, [r12, r1]
	.loc	1 103 11 is_stmt 0              @ iir/iir.c:103:11
	ldrb	r2, [sp, #3]
	.loc	1 103 8                         @ iir/iir.c:103:8
	eor	r0, r0, r2
	strb	r0, [r12, r1]
	.loc	1 102 38 is_stmt 1              @ iir/iir.c:102:38
	add	r1, r1, #1
.Ltmp20:
	@DEBUG_VALUE: iir_init:p <- [DW_OP_LLVM_arg 0, DW_OP_consts 1, DW_OP_LLVM_arg 1, DW_OP_plus, DW_OP_plus, DW_OP_stack_value] $r1, $r12
	@DEBUG_VALUE: iir_init:i <- $r1
	.loc	1 0 38 is_stmt 0                @ iir/iir.c:0:38
	b	.LBB0_7
.Ltmp21:
	.p2align	2
@ %bb.9:
.LCPI0_0:
	.long	iir_coefficients
.LCPI0_1:
	.long	iir_wi
.LCPI0_2:
	.long	iir_x
.Lfunc_end0:
	.size	iir_init, .Lfunc_end0-iir_init
	.cfi_endproc
	.cantunwind
	.fnend
                                        @ -- End function
	.globl	iir_return                      @ -- Begin function iir_return
	.p2align	2
	.type	iir_return,%function
	.code	32                              @ @iir_return
iir_return:
.Lfunc_begin1:
	.loc	1 108 0 is_stmt 1               @ iir/iir.c:108:0
	.fnstart
	.cfi_startproc
@ %bb.0:                                @ %entry
	push	{r4, r5, r11, lr}
...
.Ltmp22:
	...
	mov	r0, #0
.Ltmp23:
	@DEBUG_VALUE: iir_return:checksum <- $r0
	@DEBUG_VALUE: iir_return:f <- [DW_OP_consts 4, DW_OP_div, DW_OP_stack_value] $r4
	.loc	1 114 3 prologue_end            @ iir/iir.c:114:3
	cmp	r4, #32
	beq	.LBB1_2
.Ltmp24:
.LBB1_1:                                @ %for.body
	...
	@DEBUG_VALUE: iir_return:f <- [DW_OP_consts 4, DW_OP_div, DW_OP_stack_value] $r4
	@DEBUG_VALUE: iir_return:checksum <- $r0
	.loc	1 115 17                        @ iir/iir.c:115:17
	ldr	r1, [r5, r4]
.Ltmp25:
	@DEBUG_VALUE: iir_return:checksum <- undef
	.loc	1 115 14 is_stmt 0              @ iir/iir.c:115:14
	bl	__addsf3
.Ltmp26:
	@DEBUG_VALUE: iir_return:f <- [DW_OP_consts 4, DW_OP_div, DW_OP_consts 1, DW_OP_plus, DW_OP_stack_value] $r4
	@DEBUG_VALUE: iir_return:checksum <- undef
	.loc	1 114 3 is_stmt 1               @ iir/iir.c:114:3
	add	r4, r4, #4
.Ltmp27:
	@DEBUG_VALUE: iir_return:checksum <- $r0
	@DEBUG_VALUE: iir_return:f <- [DW_OP_consts 4, DW_OP_div, DW_OP_stack_value] $r4
	.loc	1 114 3 is_stmt 0               @ iir/iir.c:114:3
	cmp	r4, #32
	bne	.LBB1_1
.Ltmp28:
.LBB1_2:                                @ %for.end
	@DEBUG_VALUE: iir_return:f <- [DW_OP_consts 4, DW_OP_div, DW_OP_stack_value] $r4
	@DEBUG_VALUE: iir_return:checksum <- $r0
	.loc	1 117 12 is_stmt 1              @ iir/iir.c:117:12
	bl	__fixsfsi
.Ltmp29:
	.loc	1 117 3 is_stmt 0               @ iir/iir.c:117:3
	pop	{r4, r5, r11, lr}
.Ltmp30:
	bx	lr
.Ltmp31:
...
.LCPI1_0:
	.long	iir_wi
.Lfunc_end1:
	.size	iir_return, .Lfunc_end1-iir_return
	.cfi_endproc
	.cantunwind
	.fnend
                                        @ -- End function
	.globl	iir_main                        @ -- Begin function iir_main
	.p2align	2
	.type	iir_main,%function
	.code	32                              @ @iir_main
iir_main:
.Lfunc_begin2:
	.loc	1 126 0 is_stmt 1               @ iir/iir.c:126:0
	.fnstart
	.cfi_startproc
@ %bb.0:                                @ %entry
	...
	sub	sp, sp, #20
.Ltmp32:
	.loc	1 137 7 prologue_end            @ iir/iir.c:137:7
	ldr	r0, .LCPI2_0
	ldr	r7, .LCPI2_1
.Ltmp33:
	@DEBUG_VALUE: iir_main:ptr_wi1 <- $r7
	.loc	1 0 7 is_stmt 0                 @ iir/iir.c:0:7
	mov	r10, #0
.Ltmp34:
	@DEBUG_VALUE: iir_main:ptr_wi2 <- undef
	@DEBUG_VALUE: iir_main:ptr_coeff <- undef
	@DEBUG_VALUE: iir_main:f <- 0
	@DEBUG_VALUE: iir_main:y <- undef
	.loc	1 137 7                         @ iir/iir.c:137:7
	ldr	r9, [r0]
	@DEBUG_VALUE: iir_main:ptr_wi1 <- $r7
.Ltmp35:
	@DEBUG_VALUE: iir_main:y <- $r9
	@DEBUG_VALUE: iir_main:f <- [DW_OP_consts 20, DW_OP_div, DW_OP_stack_value] $r10
	@DEBUG_VALUE: iir_main:ptr_coeff <- [DW_OP_LLVM_arg 0, DW_OP_consts 20, DW_OP_div, DW_OP_consts 20, DW_OP_mul, DW_OP_LLVM_arg 0, DW_OP_plus, DW_OP_stack_value] undef
	@DEBUG_VALUE: iir_main:ptr_wi2 <- [DW_OP_LLVM_arg 0, DW_OP_consts 20, DW_OP_div, DW_OP_consts 8, DW_OP_mul, DW_OP_consts 4, DW_OP_LLVM_arg 0, DW_OP_plus, DW_OP_plus, DW_OP_stack_value] undef
	.loc	1 140 3 is_stmt 1               @ iir/iir.c:140:3
	cmp	r10, #80
	beq	.LBB2_2
.Ltmp36:
.LBB2_1:                                @ %for.body
	...
	@DEBUG_VALUE: iir_main:y <- $r9
	@DEBUG_VALUE: iir_main:ptr_wi1 <- $r7
	.loc	1 0 0 is_stmt 0                 @ iir/iir.c:0:0
	ldr	r0, .LCPI2_2
	add	r3, r7, #4
	add	r2, r0, r10
	add	r0, r7, #8
.Ltmp37:
	@DEBUG_VALUE: iir_main:ptr_coeff <- [DW_OP_LLVM_arg 0, DW_OP_consts 20, DW_OP_div, DW_OP_consts 20, DW_OP_mul, DW_OP_consts 4, DW_OP_LLVM_arg 0, DW_OP_plus, DW_OP_plus, DW_OP_stack_value] undef
	str	r0, [sp, #16]                   @ 4-byte Spill
.Ltmp38:
	.loc	1 141 13 is_stmt 1              @ iir/iir.c:141:13
	ldr	r0, [r2]
	.loc	1 141 28 is_stmt 0              @ iir/iir.c:141:28
	ldr	r1, [r7]
.Ltmp39:
	@DEBUG_VALUE: iir_main:w <- undef
	@DEBUG_VALUE: iir_main:ptr_coeff <- [DW_OP_LLVM_arg 0, DW_OP_consts 20, DW_OP_div, DW_OP_consts 20, DW_OP_mul, DW_OP_consts 8, DW_OP_LLVM_arg 0, DW_OP_plus, DW_OP_plus, DW_OP_stack_value] undef
	.loc	1 142 10 is_stmt 1              @ iir/iir.c:142:10
	ldr	r6, [r2, #4]
	.loc	1 142 25 is_stmt 0              @ iir/iir.c:142:25
	ldr	r8, [r3]
.Ltmp40:
	@DEBUG_VALUE: iir_main:ptr_coeff <- [DW_OP_LLVM_arg 0, DW_OP_consts 20, DW_OP_div, DW_OP_consts 20, DW_OP_mul, DW_OP_consts 12, DW_OP_LLVM_arg 0, DW_OP_plus, DW_OP_plus, DW_OP_stack_value] undef
	.loc	1 144 9 is_stmt 1               @ iir/iir.c:144:9
	ldr	r5, [r2, #8]
.Ltmp41:
	@DEBUG_VALUE: iir_main:ptr_coeff <- [DW_OP_LLVM_arg 0, DW_OP_consts 20, DW_OP_div, DW_OP_consts 20, DW_OP_mul, DW_OP_consts 16, DW_OP_LLVM_arg 0, DW_OP_plus, DW_OP_plus, DW_OP_stack_value] undef
	@DEBUG_VALUE: iir_main:y <- undef
	.loc	1 145 10                        @ iir/iir.c:145:10
	ldr	r4, [r2, #12]
	str	r4, [sp, #4]                    @ 4-byte Spill
	.loc	1 145 25 is_stmt 0              @ iir/iir.c:145:25
	ldr	r4, [r7]
.Ltmp42:
	@DEBUG_VALUE: iir_main:ptr_coeff <- [DW_OP_LLVM_arg 0, DW_OP_consts 20, DW_OP_div, DW_OP_consts 20, DW_OP_mul, DW_OP_consts 16, DW_OP_LLVM_arg 0, DW_OP_plus, DW_OP_plus, DW_OP_plus_uconst 4, DW_OP_stack_value] undef
	.loc	1 0 25                          @ iir/iir.c:0:25
	str	r4, [sp]                        @ 4-byte Spill
	.loc	1 146 10 is_stmt 1              @ iir/iir.c:146:10
	ldr	r2, [r2, #16]
	str	r2, [sp, #12]                   @ 4-byte Spill
	.loc	1 146 25 is_stmt 0              @ iir/iir.c:146:25
	ldr	r2, [r3]
	str	r2, [sp, #8]                    @ 4-byte Spill
	.loc	1 148 18 is_stmt 1              @ iir/iir.c:148:18
	ldr	r2, [r7]
.Ltmp43:
	@DEBUG_VALUE: iir_main:ptr_wi2 <- [DW_OP_LLVM_arg 0, DW_OP_consts 20, DW_OP_div, DW_OP_consts 8, DW_OP_mul, DW_OP_consts 4, DW_OP_LLVM_arg 0, DW_OP_plus, DW_OP_plus, DW_OP_plus_uconst 4, DW_OP_stack_value] undef
	.loc	1 148 16 is_stmt 0              @ iir/iir.c:148:16
	str	r2, [r3]
	.loc	1 141 11 is_stmt 1              @ iir/iir.c:141:11
	bl	__mulsf3
	mov	r1, r0
	mov	r0, r9
	bl	__subsf3
	mov	r4, r0
	.loc	1 142 7                         @ iir/iir.c:142:7
	mov	r0, r6
	mov	r1, r8
	bl	__mulsf3
	mov	r1, r0
	...
	mov	r1, r0
.Ltmp44:
	@DEBUG_VALUE: iir_main:ptr_wi1 <- [DW_OP_plus_uconst 4, DW_OP_stack_value] $r7
	.loc	1 149 16                        @ iir/iir.c:149:16
	str	r0, [r7]
.Ltmp45:
	@DEBUG_VALUE: iir_main:ptr_wi2 <- [DW_OP_LLVM_arg 0, DW_OP_consts 20, DW_OP_div, DW_OP_consts 8, DW_OP_mul, DW_OP_consts 12, DW_OP_LLVM_arg 0, DW_OP_plus, DW_OP_plus, DW_OP_stack_value] undef
	.loc	1 144 22                        @ iir/iir.c:144:22
	mov	r0, r5
	bl	__mulsf3
	mov	r4, r0
	.loc	1 145 7                         @ iir/iir.c:145:7
...
.Ltmp46:
	...
	mov	r9, r0
.Ltmp47:
	@DEBUG_VALUE: iir_main:ptr_coeff <- [DW_OP_LLVM_arg 0, DW_OP_consts 20, DW_OP_div, DW_OP_consts 20, DW_OP_mul, DW_OP_consts 20, DW_OP_LLVM_arg 0, DW_OP_plus, DW_OP_plus, DW_OP_stack_value] undef
	@DEBUG_VALUE: iir_main:f <- [DW_OP_consts 20, DW_OP_div, DW_OP_consts 1, DW_OP_plus, DW_OP_stack_value] $r10
	.loc	1 140 3                         @ iir/iir.c:140:3
	add	r10, r10, #20
.Ltmp48:
	@DEBUG_VALUE: iir_main:ptr_wi2 <- [DW_OP_LLVM_arg 0, DW_OP_consts 20, DW_OP_div, DW_OP_consts 8, DW_OP_mul, DW_OP_consts 4, DW_OP_LLVM_arg 0, DW_OP_plus, DW_OP_plus, DW_OP_plus_uconst 4, DW_OP_plus_uconst 4, DW_OP_stack_value] undef
	@DEBUG_VALUE: iir_main:ptr_wi1 <- [DW_OP_plus_uconst 16] [$sp+0]
	@DEBUG_VALUE: iir_main:ptr_wi1 <- $r7
	@DEBUG_VALUE: iir_main:y <- $r9
	@DEBUG_VALUE: iir_main:f <- [DW_OP_consts 20, DW_OP_div, DW_OP_stack_value] $r10
	@DEBUG_VALUE: iir_main:ptr_coeff <- [DW_OP_LLVM_arg 0, DW_OP_consts 20, DW_OP_div, DW_OP_consts 20, DW_OP_mul, DW_OP_LLVM_arg 0, DW_OP_plus, DW_OP_stack_value] undef
	@DEBUG_VALUE: iir_main:ptr_wi2 <- [DW_OP_LLVM_arg 0, DW_OP_consts 20, DW_OP_div, DW_OP_consts 8, DW_OP_mul, DW_OP_consts 4, DW_OP_LLVM_arg 0, DW_OP_plus, DW_OP_plus, DW_OP_stack_value] undef
	.loc	1 140 3 is_stmt 0               @ iir/iir.c:140:3
	cmp	r10, #80
	bne	.LBB2_1
.Ltmp49:
.LBB2_2:                                @ %for.end
	...
	@DEBUG_VALUE: iir_main:y <- $r9
	@DEBUG_VALUE: iir_main:ptr_wi1 <- $r7
	.loc	1 154 1 is_stmt 1               @ iir/iir.c:154:1
	sub	sp, r11, #28
...
.Ltmp51:
	.p2align	2
@ %bb.3:
	.loc	1 0 1 is_stmt 0                 @ iir/iir.c:0:1
.LCPI2_0:
	.long	iir_x
.LCPI2_1:
	.long	iir_wi
.LCPI2_2:
	.long	iir_coefficients
.Lfunc_end2:
	.size	iir_main, .Lfunc_end2-iir_main
	.cfi_endproc
	.cantunwind
	.fnend
                                        @ -- End function
...
main:
.Lfunc_begin3:
	.loc	1 158 0 is_stmt 1               @ iir/iir.c:158:0
	.fnstart
	.cfi_startproc
@ %bb.0:                                @ %entry
	push	{r11, lr}
...
.Ltmp52:
	.loc	1 159 3 prologue_end            @ iir/iir.c:159:3
	bl	iir_init
	.loc	1 160 3                         @ iir/iir.c:160:3
	bl	iir_main
	.loc	1 162 12                        @ iir/iir.c:162:12
	bl	iir_return
	.loc	1 162 31 is_stmt 0              @ iir/iir.c:162:31
	subs	r0, r0, #400
	movne	r0, #1
	.loc	1 162 3                         @ iir/iir.c:162:3
	pop	{r11, lr}
	bx	lr
.Ltmp53:
.Lfunc_end3:
...
.Lfunc_end4:
	.size	__absvdi2, .Lfunc_end4-__absvdi2
	.cfi_endproc
	.cantunwind
	.fnend
                                        @ -- End function
...
@ %bb.0:                                @ %entry
.Lfunc_end5:
	.size	compilerrt_abort_impl, .Lfunc_end5-compilerrt_abort_impl
	.cfi_endproc
	.cantunwind
	.fnend
                                        @ -- End function
...
.Lfunc_end6:
	.size	__absvsi2, .Lfunc_end6-__absvsi2
	.cfi_endproc
	.cantunwind
	.fnend
                                        @ -- End function
...
.Lfunc_end7:
	.size	__addvdi3, .Lfunc_end7-__addvdi3
	.cfi_endproc
	.cantunwind
	.fnend
                                        @ -- End function
...
.Lfunc_end8:
	.size	__addvsi3, .Lfunc_end8-__addvsi3
	.cfi_endproc
	.cantunwind
	.fnend
                                        @ -- End function
...
.Ltmp63:
.Lfunc_end10:
	.size	__ashrdi3, .Lfunc_end10-__ashrdi3
	.cfi_endproc
	.cantunwind
	.fnend
                                        @ -- End function
...
.Ltmp67:
.Lfunc_end12:
	.size	__clzsi2, .Lfunc_end12-__clzsi2
	.cfi_endproc
	.cantunwind
	.fnend
                                        @ -- End function
...
.Ltmp69:
.Lfunc_end13:
	.size	__cmpdi2, .Lfunc_end13-__cmpdi2
	.cfi_endproc
	.cantunwind
	.fnend
                                        @ -- End function
...
.Ltmp71:
.Lfunc_end14:
	.size	__aeabi_lcmp, .Lfunc_end14-__aeabi_lcmp
	.cfi_endproc
	.cantunwind
	.fnend
                                        @ -- End function
...
.Ltmp75:
.Lfunc_end16:
	.size	__ctzsi2, .Lfunc_end16-__ctzsi2
	.cfi_endproc
	.cantunwind
	.fnend
                                        @ -- End function
...
.Ltmp77:
.Lfunc_end17:
	.size	__divdi3, .Lfunc_end17-__divdi3
	.cfi_endproc
	.cantunwind
	.fnend
                                        @ -- End function
...
.LCPI18_3:
	.long	16843009                        @ 0x1010101
.Lfunc_end18:
	.size	__udivmoddi4, .Lfunc_end18-__udivmoddi4
	.cfi_endproc
	.cantunwind
	.fnend
                                        @ -- End function
...
.Ltmp81:
.Lfunc_end19:
	.size	__divmoddi4, .Lfunc_end19-__divmoddi4
	.cfi_endproc
	.cantunwind
	.fnend
                                        @ -- End function
...
.Ltmp83:
.Lfunc_end20:
	.size	__divmodsi4, .Lfunc_end20-__divmodsi4
	.cfi_endproc
	.cantunwind
	.fnend
                                        @ -- End function
...
.Ltmp85:
.Lfunc_end21:
	.size	__divsi3, .Lfunc_end21-__divsi3
	.cfi_endproc
	.cantunwind
	.fnend
                                        @ -- End function
...
.LCPI22_3:
	.long	16843009                        @ 0x1010101
.Lfunc_end22:
	.size	__ffsdi2, .Lfunc_end22-__ffsdi2
	.cfi_endproc
	.cantunwind
	.fnend
                                        @ -- End function
...
.LCPI23_3:
	.long	16843009                        @ 0x1010101
.Lfunc_end23:
	.size	__ffssi2, .Lfunc_end23-__ffssi2
	.cfi_endproc
	.cantunwind
	.fnend
                                        @ -- End function
...
.Ltmp92:
.Lfunc_end25:
	.size	__moddi3, .Lfunc_end25-__moddi3
	.cfi_endproc
	.cantunwind
	.fnend
                                        @ -- End function
...
.Ltmp94:
.Lfunc_end26:
	.size	__modsi3, .Lfunc_end26-__modsi3
	.cfi_endproc
	.cantunwind
	.fnend
                                        @ -- End function
...
.Lfunc_end27:
	.size	__mulvdi3, .Lfunc_end27-__mulvdi3
	.cfi_endproc
	.cantunwind
	.fnend
                                        @ -- End function
...
.Lfunc_end28:
	.size	__mulvsi3, .Lfunc_end28-__mulvsi3
	.cfi_endproc
	.cantunwind
	.fnend
                                        @ -- End function
...
.Ltmp100:
.Lfunc_end29:
	.size	__paritydi2, .Lfunc_end29-__paritydi2
	.cfi_endproc
	.cantunwind
	.fnend
                                        @ -- End function
...
.Ltmp101:
.Lfunc_end30:
	.size	__paritysi2, .Lfunc_end30-__paritysi2
	.cfi_endproc
	.cantunwind
	.fnend
                                        @ -- End function
...
.LCPI31_2:
	.long	252645135                       @ 0xf0f0f0f
.Lfunc_end31:
	.size	__popcountdi2, .Lfunc_end31-__popcountdi2
	.cfi_endproc
	.cantunwind
	.fnend
                                        @ -- End function
...
.LCPI32_2:
	.long	252645135                       @ 0xf0f0f0f
.Lfunc_end32:
	.size	__popcountsi2, .Lfunc_end32-__popcountsi2
	.cfi_endproc
	.cantunwind
	.fnend
                                        @ -- End function
...
.Lfunc_end33:
	.size	__subvdi3, .Lfunc_end33-__subvdi3
	.cfi_endproc
	.cantunwind
	.fnend
                                        @ -- End function
...
.Lfunc_end34:
	.size	__subvsi3, .Lfunc_end34-__subvsi3
	.cfi_endproc
	.cantunwind
	.fnend
                                        @ -- End function
...
.Ltmp111:
.Lfunc_end35:
	.size	__ucmpdi2, .Lfunc_end35-__ucmpdi2
	.cfi_endproc
	.cantunwind
	.fnend
                                        @ -- End function
...
.Ltmp113:
.Lfunc_end36:
	.size	__aeabi_ulcmp, .Lfunc_end36-__aeabi_ulcmp
	.cfi_endproc
	.cantunwind
	.fnend
                                        @ -- End function
...
.Ltmp117:
.Lfunc_end38:
	.size	__udivmodsi4, .Lfunc_end38-__udivmodsi4
	.cfi_endproc
	.cantunwind
	.fnend
                                        @ -- End function
...
.Ltmp121:
.Lfunc_end40:
	.size	__umoddi3, .Lfunc_end40-__umoddi3
	.cfi_endproc
	.cantunwind
	.fnend
                                        @ -- End function
...
.Ltmp123:
.Lfunc_end41:
	.size	__umodsi3, .Lfunc_end41-__umodsi3
	.cfi_endproc
	.cantunwind
	.fnend
                                        @ -- End function
...
.Ltmp124:
.Lfunc_end42:
	.size	memcpy, .Lfunc_end42-memcpy
	.cfi_endproc
	.cantunwind
	.fnend
                                        @ -- End function
...
.Ltmp126:
.Lfunc_end43:
	.size	memset, .Lfunc_end43-memset
	.cfi_endproc
	.cantunwind
	.fnend
                                        @ -- End function
	...
	.bss
	.globl	iir_coefficients
	.p2align	2
iir_coefficients:
	.zero	80
	.size	iir_coefficients, 80
...
.Ldebug_info_start0:
	...
	.byte	1                               @ Abbrev [1] 0xc:0x11b DW_TAG_compile_unit
	...
	.byte	5                               @ Abbrev [5] 0x3e:0x5 DW_TAG_volatile_type
	.long	67                              @ DW_AT_type
	...
	.byte	2                               @ Abbrev [2] 0x4b:0xb DW_TAG_variable
	.byte	6                               @ DW_AT_name
	.long	86                              @ DW_AT_type
                                        @ DW_AT_external
	.byte	1                               @ DW_AT_decl_file
	...
	.byte	161
	.byte	1
	.byte	3                               @ Abbrev [3] 0x56:0xc DW_TAG_array_type
	.long	62                              @ DW_AT_type
	.byte	4                               @ Abbrev [4] 0x5b:0x6 DW_TAG_subrange_type
	.long	71                              @ DW_AT_type
	.byte	20                              @ DW_AT_count
	.byte	0                               @ End Of Children Mark
	...
	.byte	161
	.byte	2
	.byte	8                               @ Abbrev [8] 0x6d:0x5 DW_TAG_pointer_type
	.long	114                             @ DW_AT_type
	.byte	6                               @ Abbrev [6] 0x72:0x4 DW_TAG_base_type
	.byte	8                               @ DW_AT_name
	...
	.byte	4                               @ DW_AT_byte_size
	.byte	9                               @ Abbrev [9] 0x7a:0x32 DW_TAG_subprogram
	.byte	3                               @ DW_AT_low_pc
	...
	.byte	74                              @ DW_AT_decl_line
                                        @ DW_AT_prototyped
                                        @ DW_AT_external
	.byte	10                              @ Abbrev [10] 0x85:0xb DW_TAG_variable
	.byte	2                               @ DW_AT_location
	.byte	125
	.byte	3
	.byte	54                              @ DW_AT_name
	...
	.long	276                             @ DW_AT_type
	.byte	11                              @ Abbrev [11] 0x90:0x9 DW_TAG_variable
	.byte	0                               @ DW_AT_location
	.byte	56                              @ DW_AT_name
	.byte	1                               @ DW_AT_decl_file
	.byte	76                              @ DW_AT_decl_line
	.long	118                             @ DW_AT_type
	.byte	11                              @ Abbrev [11] 0x99:0x9 DW_TAG_variable
	.byte	1                               @ DW_AT_location
	.byte	57                              @ DW_AT_name
	.byte	1                               @ DW_AT_decl_file
	.byte	78                              @ DW_AT_decl_line
	.long	109                             @ DW_AT_type
	.byte	11                              @ Abbrev [11] 0xa2:0x9 DW_TAG_variable
	.byte	2                               @ DW_AT_location
	.byte	58                              @ DW_AT_name
	.byte	1                               @ DW_AT_decl_file
	...
	.long	285                             @ DW_AT_type
	.byte	0                               @ End Of Children Mark
	.byte	12                              @ Abbrev [12] 0xac:0x22 DW_TAG_subprogram
	.byte	4                               @ DW_AT_low_pc
	...
	.long	118                             @ DW_AT_type
                                        @ DW_AT_external
	.byte	11                              @ Abbrev [11] 0xbb:0x9 DW_TAG_variable
	.byte	3                               @ DW_AT_location
	.byte	56                              @ DW_AT_name
	.byte	1                               @ DW_AT_decl_file
	.byte	110                             @ DW_AT_decl_line
	.long	118                             @ DW_AT_type
	.byte	11                              @ Abbrev [11] 0xc4:0x9 DW_TAG_variable
	...
	.long	67                              @ DW_AT_type
	.byte	0                               @ End Of Children Mark
	.byte	9                               @ Abbrev [9] 0xce:0x37 DW_TAG_subprogram
	.byte	5                               @ DW_AT_low_pc
	...
	.byte	125                             @ DW_AT_decl_line
                                        @ DW_AT_prototyped
                                        @ DW_AT_external
	.byte	11                              @ Abbrev [11] 0xd9:0x9 DW_TAG_variable
	.byte	5                               @ DW_AT_location
	.byte	61                              @ DW_AT_name
	.byte	1                               @ DW_AT_decl_file
	.byte	129                             @ DW_AT_decl_line
	.long	289                             @ DW_AT_type
	.byte	13                              @ Abbrev [13] 0xe2:0x8 DW_TAG_variable
	.byte	62                              @ DW_AT_name
	.byte	1                               @ DW_AT_decl_file
	.byte	129                             @ DW_AT_decl_line
	.long	289                             @ DW_AT_type
	.byte	13                              @ Abbrev [13] 0xea:0x8 DW_TAG_variable
	.byte	63                              @ DW_AT_name
	.byte	1                               @ DW_AT_decl_file
	.byte	129                             @ DW_AT_decl_line
	.long	289                             @ DW_AT_type
	.byte	11                              @ Abbrev [11] 0xf2:0x9 DW_TAG_variable
	.byte	6                               @ DW_AT_location
	.byte	56                              @ DW_AT_name
	.byte	1                               @ DW_AT_decl_file
	.byte	128                             @ DW_AT_decl_line
	.long	118                             @ DW_AT_type
	.byte	11                              @ Abbrev [11] 0xfb:0x9 DW_TAG_variable
	...
	.long	67                              @ DW_AT_type
	.byte	0                               @ End Of Children Mark
	.byte	14                              @ Abbrev [14] 0x105:0xf DW_TAG_subprogram
	.byte	6                               @ DW_AT_low_pc
	...
	.long	118                             @ DW_AT_type
                                        @ DW_AT_external
	.byte	5                               @ Abbrev [5] 0x114:0x5 DW_TAG_volatile_type
	.long	281                             @ DW_AT_type
...
.Ldebug_info_start10:
	...
	.long	.Lfunc_end14-.Lfunc_begin13     @ DW_AT_high_pc
	.long	.Laddr_table_base0              @ DW_AT_addr_base
	.long	.Lloclists_table_base0          @ DW_AT_loclists_base
.Ldebug_info_end10:
.Lcu_begin11:
...
.Ldebug_info_start31:
	...
	.long	.Lfunc_end36-.Lfunc_begin35     @ DW_AT_high_pc
	.long	.Laddr_table_base0              @ DW_AT_addr_base
	.long	.Lloclists_table_base0          @ DW_AT_loclists_base
.Ldebug_info_end31:
.Lcu_begin32:
...
.Ldebug_info_start37:
	...
	.long	.Lfunc_end43-.Lfunc_begin42     @ DW_AT_high_pc
	.long	.Laddr_table_base0              @ DW_AT_addr_base
	.long	.Lloclists_table_base0          @ DW_AT_loclists_base
.Ldebug_info_end37:
...
.Linfo_string1:
	.asciz	"/workspaces/llvmta/testcases/singletest/iir/iir.c" @ string offset=100
.Linfo_string2:
	.asciz	"/workspaces/llvmta/testcases/singletest/h264_dec" @ string offset=150
.Linfo_string3:
	.asciz	"iir_wi"                        @ string offset=199
.Linfo_string4:
	.asciz	"float"                         @ string offset=206
.Linfo_string5:
	.asciz	"__ARRAY_SIZE_TYPE__"           @ string offset=212
.Linfo_string6:
	.asciz	"iir_coefficients"              @ string offset=232
.Linfo_string7:
	.asciz	"iir_x"                         @ string offset=249
.Linfo_string8:
	.asciz	"unsigned char"                 @ string offset=255
.Linfo_string9:
	.asciz	"int"                           @ string offset=269
.Linfo_string10:
	.asciz	"clang version 14.0.6 (git@gitlab.tu-dortmund.de:f4-ls12-daes/llvmta/llvmta.git 64262528b05c9d91a76d9ec1ec1045982f385529)" @ string offset=273
.Linfo_string11:
	.asciz	"../absvdi2.c"                  @ string offset=394
.Linfo_string12:
	.asciz	"/workspaces/llvmta/testcases/libraries/builtinsint/buildarmv4" @ string offset=407
.Linfo_string13:
	.asciz	"../int_util.c"                 @ string offset=469
.Linfo_string14:
	.asciz	"../absvsi2.c"                  @ string offset=483
.Linfo_string15:
	.asciz	"../addvdi3.c"                  @ string offset=496
.Linfo_string16:
	.asciz	"../addvsi3.c"                  @ string offset=509
.Linfo_string17:
	.asciz	"../ashldi3.c"                  @ string offset=522
.Linfo_string18:
	.asciz	"../ashrdi3.c"                  @ string offset=535
.Linfo_string19:
	.asciz	"../clzdi2.c"                   @ string offset=548
.Linfo_string20:
	.asciz	"../clzsi2.c"                   @ string offset=560
.Linfo_string21:
	.asciz	"../cmpdi2.c"                   @ string offset=572
.Linfo_string22:
	.asciz	"../ctzdi2.c"                   @ string offset=584
.Linfo_string23:
	.asciz	"../ctzsi2.c"                   @ string offset=596
.Linfo_string24:
	.asciz	"../divdi3.c"                   @ string offset=608
.Linfo_string25:
	.asciz	"../udivmoddi4.c"               @ string offset=620
.Linfo_string26:
	.asciz	"../divmoddi4.c"                @ string offset=636
.Linfo_string27:
	.asciz	"../divmodsi4.c"                @ string offset=651
.Linfo_string28:
	.asciz	"../divsi3.c"                   @ string offset=666
.Linfo_string29:
	.asciz	"../ffsdi2.c"                   @ string offset=678
.Linfo_string30:
	.asciz	"../ffssi2.c"                   @ string offset=690
.Linfo_string31:
	.asciz	"../lshrdi3.c"                  @ string offset=702
.Linfo_string32:
	.asciz	"../moddi3.c"                   @ string offset=715
.Linfo_string33:
	.asciz	"../modsi3.c"                   @ string offset=727
.Linfo_string34:
	.asciz	"../mulvdi3.c"                  @ string offset=739
.Linfo_string35:
	.asciz	"../mulvsi3.c"                  @ string offset=752
.Linfo_string36:
	.asciz	"../paritydi2.c"                @ string offset=765
.Linfo_string37:
	.asciz	"../paritysi2.c"                @ string offset=780
.Linfo_string38:
	.asciz	"../popcountdi2.c"              @ string offset=795
.Linfo_string39:
	.asciz	"../popcountsi2.c"              @ string offset=812
.Linfo_string40:
	.asciz	"../subvdi3.c"                  @ string offset=829
.Linfo_string41:
	.asciz	"../subvsi3.c"                  @ string offset=842
.Linfo_string42:
	.asciz	"../ucmpdi2.c"                  @ string offset=855
.Linfo_string43:
	.asciz	"../udivdi3.c"                  @ string offset=868
.Linfo_string44:
	.asciz	"../udivmodsi4.c"               @ string offset=881
.Linfo_string45:
	.asciz	"../udivsi3.c"                  @ string offset=897
.Linfo_string46:
	.asciz	"../umoddi3.c"                  @ string offset=910
.Linfo_string47:
	.asciz	"../umodsi3.c"                  @ string offset=923
.Linfo_string48:
	.asciz	"../memory.c"                   @ string offset=936
.Linfo_string49:
	.asciz	"/workspaces/llvmta/testcases/libraries/builtinsstd/buildarmv4" @ string offset=948
.Linfo_string50:
	.asciz	"iir_init"                      @ string offset=1010
.Linfo_string51:
	.asciz	"iir_return"                    @ string offset=1019
.Linfo_string52:
	.asciz	"iir_main"                      @ string offset=1030
.Linfo_string53:
	.asciz	"main"                          @ string offset=1039
.Linfo_string54:
	.asciz	"bitmask"                       @ string offset=1044
.Linfo_string55:
	.asciz	"char"                          @ string offset=1052
.Linfo_string56:
	.asciz	"f"                             @ string offset=1057
.Linfo_string57:
	.asciz	"p"                             @ string offset=1059
.Linfo_string58:
	.asciz	"i"                             @ string offset=1061
.Linfo_string59:
	.asciz	"unsigned int"                  @ string offset=1063
.Linfo_string60:
	.asciz	"checksum"                      @ string offset=1076
.Linfo_string61:
	.asciz	"ptr_wi1"                       @ string offset=1085
.Linfo_string62:
	.asciz	"ptr_wi2"                       @ string offset=1093
.Linfo_string63:
	.asciz	"ptr_coeff"                     @ string offset=1101
.Linfo_string64:
	.asciz	"y"                             @ string offset=1111
	.section	.debug_str_offsets,"",%progbits
	.long	.Linfo_string0
	.long	.Linfo_string1
	.long	.Linfo_string2
