...
fib:
.Lfunc_begin0:
	.file	1 "/workspaces/llvmta/testcases" "batchtest/fibcall/fibcall.c" md5 0x0bdb6a79a798df4924d18fe412553ffa
	.loc	1 45 0                          @ batchtest/fibcall/fibcall.c:45:0
	.fnstart
...
.Ltmp0:
	.loc	1 50 8 prologue_end             @ batchtest/fibcall/fibcall.c:50:8
	b	.LBB0_1
.LBB0_1:                                @ %for.cond
                                        @ =>This Inner Loop Header: Depth=1
	.loc	1 0 0 is_stmt 0                 @ batchtest/fibcall/fibcall.c:0:0
	...
	mov	r0, #0
	.loc	1 50 23                         @ batchtest/fibcall/fibcall.c:50:23
	cmp	r1, #10
...
.LBB0_2:                                @ %land.rhs
	...
	.loc	1 0 23                          @ batchtest/fibcall/fibcall.c:0:23
	ldr	r1, [sp, #4]                    @ 4-byte Reload
	ldr	r2, [sp, #16]                   @ 4-byte Reload
	mov	r0, #0
	.loc	1 50 28                         @ batchtest/fibcall/fibcall.c:50:28
	cmp	r1, r2
	movle	r0, #1
	str	r0, [sp, #12]                   @ 4-byte Spill
	b	.LBB0_3
.LBB0_3:                                @ %land.end
                                        @   in Loop: Header=BB0_1 Depth=1
	.loc	1 0 0                           @ batchtest/fibcall/fibcall.c:0:0
	ldr	r0, [sp, #12]                   @ 4-byte Reload
	.loc	1 50 3                          @ batchtest/fibcall/fibcall.c:50:3
	tst	r0, #1
	beq	.LBB0_6
	b	.LBB0_4
.LBB0_4:                                @ %for.body
                                        @   in Loop: Header=BB0_1 Depth=1
	.loc	1 55 3 is_stmt 1                @ batchtest/fibcall/fibcall.c:55:3
	b	.LBB0_5
.LBB0_5:                                @ %for.inc
                                        @   in Loop: Header=BB0_1 Depth=1
	.loc	1 53 17                         @ batchtest/fibcall/fibcall.c:53:17
	ldr	r0, [sp, #8]                    @ 4-byte Reload
	ldr	r1, [sp, #4]                    @ 4-byte Reload
	ldr	r2, [sp]                        @ 4-byte Reload
	add	r2, r0, r2
	.loc	1 51 9                          @ batchtest/fibcall/fibcall.c:51:9
	add	r1, r1, #1
	str	r2, [sp, #20]                   @ 4-byte Spill
	str	r1, [sp, #24]                   @ 4-byte Spill
	str	r0, [sp, #28]                   @ 4-byte Spill
	...
	b	.LBB0_1
.LBB0_6:                                @ %for.end
	.loc	1 57 3                          @ batchtest/fibcall/fibcall.c:57:3
	ldr	r0, [sp, #8]                    @ 4-byte Reload
	add	sp, sp, #32
	bx	lr
.Ltmp1:
...
main:
.Lfunc_begin1:
	.loc	1 60 0                          @ batchtest/fibcall/fibcall.c:60:0
	.fnstart
	.cfi_startproc
@ %bb.0:                                @ %entry
	push	{r11, lr}
...
.Ltmp2:
	.loc	1 64 3 prologue_end             @ batchtest/fibcall/fibcall.c:64:3
	bl	fib
                                        @ kill: def $r1 killed $r0
	.loc	1 65 3                          @ batchtest/fibcall/fibcall.c:65:3
...
.Linfo_string1:
	.asciz	"/workspaces/llvmta/testcases/batchtest/fibcall/fibcall.c" @ string offset=100
.Linfo_string2:
	.asciz	"/workspaces/llvmta/testcases/tmp.hQmegGB5Y8" @ string offset=157
.Linfo_string3:
