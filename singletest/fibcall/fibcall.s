...
fib:
.Lfunc_begin0:
	.file	1 "/workspaces/llvmta/testcases/singletest" "fibcall/fibcall.c"
	.loc	1 45 0                          @ fibcall/fibcall.c:45:0
	.fnstart
	.cfi_sections .debug_frame
	.cfi_startproc
@ %bb.0:                                @ %entry
	@DEBUG_VALUE: fib:n <- $r0
	mov	r12, #0
	mov	r2, #2
	mov	r3, #1
.Ltmp0:
	@DEBUG_VALUE: fib:i <- 2
	@DEBUG_VALUE: fib:Fold <- 0
	@DEBUG_VALUE: fib:Fnew <- 1
	b	.LBB0_3
.Ltmp1:
.LBB0_1:                                @ %land.end
                                        @   in Loop: Header=BB0_3 Depth=1
	@DEBUG_VALUE: fib:Fnew <- $r1
	@DEBUG_VALUE: fib:Fold <- $r12
	@DEBUG_VALUE: fib:i <- $r2
	.loc	1 50 3 prologue_end             @ fibcall/fibcall.c:50:3
	cmp	r3, #0
.Ltmp2:
	@DEBUG_VALUE: fib:ans <- $r1
	.loc	1 57 3                          @ fibcall/fibcall.c:57:3
	moveq	r0, r1
.Ltmp3:
	@DEBUG_VALUE: fib:n <- [DW_OP_LLVM_entry_value 1] $r0
	bxeq	lr
.Ltmp4:
.LBB0_2:                                @ %for.body
                                        @   in Loop: Header=BB0_3 Depth=1
	...
	@DEBUG_VALUE: fib:Fold <- $r12
	@DEBUG_VALUE: fib:i <- $r2
	@DEBUG_VALUE: fib:Fnew <- [DW_OP_LLVM_arg 0, DW_OP_LLVM_arg 1, DW_OP_plus, DW_OP_stack_value] $r1, $r12
	@DEBUG_VALUE: fib:Fold <- $r1
	@DEBUG_VALUE: fib:temp <- $r1
	.loc	1 53 17                         @ fibcall/fibcall.c:53:17
	add	r3, r1, r12
.Ltmp5:
	@DEBUG_VALUE: fib:Fnew <- $r3
	.loc	1 51 9                          @ fibcall/fibcall.c:51:9
	add	r2, r2, #1
.Ltmp6:
	@DEBUG_VALUE: fib:i <- $r2
	.loc	1 0 9 is_stmt 0                 @ fibcall/fibcall.c:0:9
	mov	r12, r1
.Ltmp7:
	@DEBUG_VALUE: fib:temp <- $r12
	@DEBUG_VALUE: fib:Fold <- $r12
.LBB0_3:                                @ %for.cond
...
.Ltmp8:
	...
	@DEBUG_VALUE: fib:Fold <- $r12
	@DEBUG_VALUE: fib:Fnew <- $r1
	.loc	1 50 23 is_stmt 1               @ fibcall/fibcall.c:50:23
	cmp	r2, #30
	mov	r3, #0
	bhi	.LBB0_1
.Ltmp9:
@ %bb.4:                                @ %land.rhs
	...
	@DEBUG_VALUE: fib:Fold <- $r12
	@DEBUG_VALUE: fib:i <- $r2
	.loc	1 50 28 is_stmt 0               @ fibcall/fibcall.c:50:28
	cmp	r2, r0
	mov	r3, #0
	movle	r3, #1
	b	.LBB0_1
...
main:
.Lfunc_begin1:
	.loc	1 60 0 is_stmt 1                @ fibcall/fibcall.c:60:0
	.fnstart
	.cfi_startproc
@ %bb.0:                                @ %entry
	push	{r11, lr}
...
.Ltmp11:
	@DEBUG_VALUE: main:a <- 30
	.loc	1 64 3 prologue_end             @ fibcall/fibcall.c:64:3
	mov	r0, #30
	bl	fib
	.loc	1 65 3                          @ fibcall/fibcall.c:65:3
	mov	r0, #30
	pop	{r11, lr}
	bx	lr
.Ltmp12:
...
.Ldebug_info_start0:
	...
	.byte	2                               @ Abbrev [2] 0x27:0x46 DW_TAG_subprogram
	.byte	0                               @ DW_AT_low_pc
	...
	.byte	46                              @ DW_AT_decl_line
	.long	134                             @ DW_AT_type
	.byte	4                               @ Abbrev [4] 0x5a:0x9 DW_TAG_variable
	...
	.byte	5                               @ Abbrev [5] 0x6d:0x19 DW_TAG_subprogram
	.byte	1                               @ DW_AT_low_pc
	...
	.long	134                             @ DW_AT_type
                                        @ DW_AT_external
	.byte	6                               @ Abbrev [6] 0x7c:0x9 DW_TAG_variable
	...
	.long	134                             @ DW_AT_type
	.byte	0                               @ End Of Children Mark
	.byte	7                               @ Abbrev [7] 0x86:0x4 DW_TAG_base_type
	.byte	44                              @ DW_AT_name
...
.Linfo_string1:
	.asciz	"/workspaces/llvmta/testcases/singletest/fibcall/fibcall.c" @ string offset=100
.Linfo_string2:
	.asciz	"/workspaces/llvmta/testcases/singletest/fdct" @ string offset=158
.Linfo_string3:
...
.Linfo_string43:
	.asciz	"fib"                           @ string offset=940
.Linfo_string44:
	.asciz	"int"                           @ string offset=944
.Linfo_string45:
	.asciz	"main"                          @ string offset=948
.Linfo_string46:
	.asciz	"n"                             @ string offset=953
.Linfo_string47:
	.asciz	"i"                             @ string offset=955
.Linfo_string48:
	.asciz	"Fold"                          @ string offset=957
.Linfo_string49:
	.asciz	"Fnew"                          @ string offset=962
.Linfo_string50:
	.asciz	"ans"                           @ string offset=967
.Linfo_string51:
	.asciz	"temp"                          @ string offset=971
.Linfo_string52:
	.asciz	"a"                             @ string offset=976
	.section	.debug_str_offsets,"",%progbits
	.long	.Linfo_string0
	.long	.Linfo_string1
	.long	.Linfo_string2
