...
bsort_Initialize:
.Lfunc_begin0:
	.file	1 "/workspaces/llvmta/testcases" "batchtest/bsort/bsort.c" md5 0x22bdadf7e534bd78c02410801317c4e1
	.loc	1 52 0                          @ batchtest/bsort/bsort.c:52:0
	.fnstart
...
.Ltmp0:
	.loc	1 56 9 prologue_end             @ batchtest/bsort/bsort.c:56:9
	b	.LBB0_1
.LBB0_1:                                @ %for.cond
                                        @ =>This Inner Loop Header: Depth=1
	.loc	1 0 0 is_stmt 0                 @ batchtest/bsort/bsort.c:0:0
	ldr	r0, [sp, #8]                    @ 4-byte Reload
	str	r0, [sp]                        @ 4-byte Spill
	.loc	1 56 3                          @ batchtest/bsort/bsort.c:56:3
	cmp	r0, #3
	beq	.LBB0_4
	b	.LBB0_2
.LBB0_2:                                @ %for.body
                                        @   in Loop: Header=BB0_1 Depth=1
	.loc	1 57 36 is_stmt 1               @ batchtest/bsort/bsort.c:57:36
	ldr	r1, [sp, #4]                    @ 4-byte Reload
	ldr	r2, [sp]                        @ 4-byte Reload
	mvn	r0, r2
	.loc	1 57 20 is_stmt 0               @ batchtest/bsort/bsort.c:57:20
	str	r0, [r1, r2, lsl #2]
	.loc	1 57 5                          @ batchtest/bsort/bsort.c:57:5
	b	.LBB0_3
.LBB0_3:                                @ %for.inc
                                        @   in Loop: Header=BB0_1 Depth=1
	.loc	1 56 46 is_stmt 1               @ batchtest/bsort/bsort.c:56:46
	ldr	r0, [sp]                        @ 4-byte Reload
	add	r0, r0, #1
	str	r0, [sp, #8]                    @ 4-byte Spill
	.loc	1 56 3 is_stmt 0                @ batchtest/bsort/bsort.c:56:3
	b	.LBB0_1
.LBB0_4:                                @ %for.end
	.loc	1 0 3                           @ batchtest/bsort/bsort.c:0:3
	mov	r0, #0
	.loc	1 59 3 is_stmt 1                @ batchtest/bsort/bsort.c:59:3
	add	sp, sp, #12
	bx	lr
.Ltmp1:
.Lfunc_end0:
...
bsort_init:
.Lfunc_begin1:
	.loc	1 64 0                          @ batchtest/bsort/bsort.c:64:0
	.fnstart
	.cfi_startproc
@ %bb.0:                                @ %entry
	push	{r11, lr}
...
.Ltmp2:
	.loc	1 65 3 prologue_end             @ batchtest/bsort/bsort.c:65:3
	ldr	r0, .LCPI1_0
	bl	bsort_Initialize
	.loc	1 66 1                          @ batchtest/bsort/bsort.c:66:1
	pop	{r11, lr}
	bx	lr
.Ltmp3:
	.p2align	2
@ %bb.1:
	.loc	1 0 1 is_stmt 0                 @ batchtest/bsort/bsort.c:0:1
.LCPI1_0:
	.long	bsort_Array
.Lfunc_end1:
...
bsort_return:
.Lfunc_begin2:
	.loc	1 70 0 is_stmt 1                @ batchtest/bsort/bsort.c:70:0
	.fnstart
	.cfi_startproc
@ %bb.0:                                @ %entry
	sub	sp, sp, #20
...
.Ltmp4:
	.loc	1 75 9 prologue_end             @ batchtest/bsort/bsort.c:75:9
	b	.LBB2_1
.LBB2_1:                                @ %for.cond
                                        @ =>This Inner Loop Header: Depth=1
	.loc	1 0 0 is_stmt 0                 @ batchtest/bsort/bsort.c:0:0
	...
	str	r0, [sp, #8]                    @ 4-byte Spill
	.loc	1 75 3                          @ batchtest/bsort/bsort.c:75:3
	cmp	r0, #2
	beq	.LBB2_6
	b	.LBB2_2
.LBB2_2:                                @ %for.body
                                        @   in Loop: Header=BB2_1 Depth=1
	.loc	1 77 14 is_stmt 1               @ batchtest/bsort/bsort.c:77:14
	ldr	r0, [sp, #4]                    @ 4-byte Reload
	rsbs	r1, r0, #0
	adc	r1, r0, r1
	str	r1, [sp]                        @ 4-byte Spill
	.loc	1 77 21 is_stmt 0               @ batchtest/bsort/bsort.c:77:21
	cmp	r0, #0
	beq	.LBB2_4
	b	.LBB2_3
.LBB2_3:                                @ %land.rhs
                                        @   in Loop: Header=BB2_1 Depth=1
	.loc	1 0 21                          @ batchtest/bsort/bsort.c:0:21
	b	.LBB2_4
.LBB2_4:                                @ %land.end
                                        @   in Loop: Header=BB2_1 Depth=1
	.loc	1 77 5                          @ batchtest/bsort/bsort.c:77:5
	b	.LBB2_5
.LBB2_5:                                @ %for.inc
                                        @   in Loop: Header=BB2_1 Depth=1
	.loc	1 0 5                           @ batchtest/bsort/bsort.c:0:5
	ldr	r1, [sp, #8]                    @ 4-byte Reload
	ldr	r2, [sp]                        @ 4-byte Reload
	mov	r0, #1
	.loc	1 77 21                         @ batchtest/bsort/bsort.c:77:21
	bic	r0, r0, r2
	.loc	1 75 50 is_stmt 1               @ batchtest/bsort/bsort.c:75:50
	add	r1, r1, #1
	str	r1, [sp, #12]                   @ 4-byte Spill
	str	r0, [sp, #16]                   @ 4-byte Spill
	.loc	1 75 3 is_stmt 0                @ batchtest/bsort/bsort.c:75:3
	b	.LBB2_1
.LBB2_6:                                @ %for.end
	.loc	1 79 12 is_stmt 1               @ batchtest/bsort/bsort.c:79:12
	ldr	r0, [sp, #4]                    @ 4-byte Reload
	eor	r0, r0, #1
	.loc	1 79 3 is_stmt 0                @ batchtest/bsort/bsort.c:79:3
	add	sp, sp, #20
	bx	lr
.Ltmp5:
.Lfunc_end2:
...
bsort_BubbleSort:
.Lfunc_begin3:
	.loc	1 90 0 is_stmt 1                @ batchtest/bsort/bsort.c:90:0
	.fnstart
	.cfi_startproc
@ %bb.0:                                @ %entry
	sub	sp, sp, #20
	...
	str	r0, [sp, #16]                   @ 4-byte Spill
.Ltmp6:
	.loc	1 95 9 prologue_end             @ batchtest/bsort/bsort.c:95:9
	b	.LBB3_1
.LBB3_1:                                @ %for.cond
	...
	str	r0, [sp, #8]                    @ 4-byte Spill
	.loc	1 95 3                          @ batchtest/bsort/bsort.c:95:3
	cmp	r0, #2
	beq	.LBB3_8
	b	.LBB3_2
.LBB3_2:                                @ %for.body
	...
	mov	r0, #0
	str	r0, [sp, #4]                    @ 4-byte Spill
	.loc	1 98 11 is_stmt 1               @ batchtest/bsort/bsort.c:98:11
	b	.LBB3_3
.LBB3_3:                                @ %for.cond1
	...
	ldr	r0, [sp, #4]                    @ 4-byte Reload
	str	r0, [sp]                        @ 4-byte Spill
	.loc	1 98 5                          @ batchtest/bsort/bsort.c:98:5
	cmp	r0, #2
	beq	.LBB3_6
	b	.LBB3_4
.LBB3_4:                                @ %for.body3
                                        @   in Loop: Header=BB3_3 Depth=2
	.loc	1 102 16 is_stmt 1              @ batchtest/bsort/bsort.c:102:16
	ldr	r0, [sp]                        @ 4-byte Reload
	ldr	r1, [sp, #12]                   @ 4-byte Reload
	ldr	r0, [r1, r0, lsl #2]!
	.loc	1 103 26                        @ batchtest/bsort/bsort.c:103:26
	ldr	r2, [r1, #4]
	.loc	1 103 24 is_stmt 0              @ batchtest/bsort/bsort.c:103:24
	str	r2, [r1]
	.loc	1 104 28 is_stmt 1              @ batchtest/bsort/bsort.c:104:28
	str	r0, [r1, #4]
	.loc	1 107 5                         @ batchtest/bsort/bsort.c:107:5
	b	.LBB3_5
.LBB3_5:                                @ %for.inc
                                        @   in Loop: Header=BB3_3 Depth=2
	.loc	1 98 52                         @ batchtest/bsort/bsort.c:98:52
	ldr	r0, [sp]                        @ 4-byte Reload
	add	r0, r0, #1
	str	r0, [sp, #4]                    @ 4-byte Spill
	.loc	1 98 5 is_stmt 0                @ batchtest/bsort/bsort.c:98:5
	b	.LBB3_3
.LBB3_6:                                @ %for.end
                                        @   in Loop: Header=BB3_1 Depth=1
	.loc	1 111 3 is_stmt 1               @ batchtest/bsort/bsort.c:111:3
	b	.LBB3_7
.LBB3_7:                                @ %for.inc8
                                        @   in Loop: Header=BB3_1 Depth=1
	.loc	1 95 38                         @ batchtest/bsort/bsort.c:95:38
	ldr	r0, [sp, #8]                    @ 4-byte Reload
	add	r0, r0, #1
	str	r0, [sp, #16]                   @ 4-byte Spill
	.loc	1 95 3 is_stmt 0                @ batchtest/bsort/bsort.c:95:3
	b	.LBB3_1
.LBB3_8:                                @ %for.end10
	.loc	1 0 3                           @ batchtest/bsort/bsort.c:0:3
	mov	r0, #0
	.loc	1 113 3 is_stmt 1               @ batchtest/bsort/bsort.c:113:3
	add	sp, sp, #20
	bx	lr
.Ltmp7:
.Lfunc_end3:
...
bsort_main:
.Lfunc_begin4:
	.loc	1 118 0                         @ batchtest/bsort/bsort.c:118:0
	.fnstart
	.cfi_startproc
@ %bb.0:                                @ %entry
	push	{r11, lr}
	...
	.cfi_def_cfa_register r11
.Ltmp8:
	.loc	1 119 3 prologue_end            @ batchtest/bsort/bsort.c:119:3
	ldr	r0, .LCPI4_0
	bl	bsort_BubbleSort
	.loc	1 120 1                         @ batchtest/bsort/bsort.c:120:1
	pop	{r11, lr}
	bx	lr
.Ltmp9:
	.p2align	2
...
main:
.Lfunc_begin5:
	.loc	1 128 0 is_stmt 1               @ batchtest/bsort/bsort.c:128:0
	.fnstart
	.cfi_startproc
@ %bb.0:                                @ %entry
	push	{r11, lr}
	...
	.cfi_def_cfa_register r11
.Ltmp10:
	.loc	1 129 3 prologue_end            @ batchtest/bsort/bsort.c:129:3
	bl	bsort_init
	.loc	1 130 3                         @ batchtest/bsort/bsort.c:130:3
	bl	bsort_main
	.loc	1 132 10                        @ batchtest/bsort/bsort.c:132:10
	bl	bsort_return
	.loc	1 132 3 is_stmt 0               @ batchtest/bsort/bsort.c:132:3
	pop	{r11, lr}
	bx	lr
.Ltmp11:
.Lfunc_end5:
...
.Linfo_string1:
	.asciz	"/workspaces/llvmta/testcases/batchtest/bsort/bsort.c" @ string offset=100
.Linfo_string2:
	.asciz	"/workspaces/llvmta/testcases/tmp.ncvcRlIRsF" @ string offset=153
.Linfo_string3:
