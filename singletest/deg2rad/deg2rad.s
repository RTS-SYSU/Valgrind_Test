	...
	.file	"llvm-link"
	.file	1 "/workspaces/llvmta/testcases/singletest" "deg2rad/deg2rad.c"
	.globl	deg2rad_init                    @ -- Begin function deg2rad_init
	.p2align	2
	.type	deg2rad_init,%function
	.code	32                              @ @deg2rad_init
deg2rad_init:
.Lfunc_begin0:
	.loc	1 50 0                          @ deg2rad/deg2rad.c:50:0
	.fnstart
	.cfi_sections .debug_frame
	.cfi_startproc
@ %bb.0:                                @ %entry
	.loc	1 52 13 prologue_end            @ deg2rad/deg2rad.c:52:13
	ldr	r0, .LCPI0_0
	mov	r1, #0
	str	r1, [r0]
	.loc	1 51 13                         @ deg2rad/deg2rad.c:51:13
	ldr	r0, .LCPI0_1
	str	r1, [r0]
	.loc	1 53 1                          @ deg2rad/deg2rad.c:53:1
	bx	lr
.Ltmp0:
	.p2align	2
@ %bb.1:
	.loc	1 0 1 is_stmt 0                 @ deg2rad/deg2rad.c:0:1
.LCPI0_0:
	.long	deg2rad_Y
.LCPI0_1:
	.long	deg2rad_X
.Lfunc_end0:
	.size	deg2rad_init, .Lfunc_end0-deg2rad_init
	.cfi_endproc
	.cantunwind
	.fnend
                                        @ -- End function
	.globl	deg2rad_return                  @ -- Begin function deg2rad_return
	.p2align	2
	.type	deg2rad_return,%function
	.code	32                              @ @deg2rad_return
deg2rad_return:
.Lfunc_begin1:
	.loc	1 61 0 is_stmt 1                @ deg2rad/deg2rad.c:61:0
	.fnstart
	.cfi_startproc
@ %bb.0:                                @ %entry
	push	{r11, lr}
...
.Ltmp1:
	.loc	1 62 14 prologue_end            @ deg2rad/deg2rad.c:62:14
	ldr	r0, .LCPI1_0
	ldr	r0, [r0]
	bl	__fixsfsi
	mov	r2, #109
	mov	r1, r0
.Ltmp2:
	@DEBUG_VALUE: deg2rad_return:temp <- $r1
	.loc	1 0 14 is_stmt 0                @ deg2rad/deg2rad.c:0:14
	mov	r0, #0
	orr	r2, r2, #1024
	.loc	1 64 8 is_stmt 1                @ deg2rad/deg2rad.c:64:8
	cmp	r1, r2
	mvnne	r0, #0
	.loc	1 69 1                          @ deg2rad/deg2rad.c:69:1
	pop	{r11, lr}
	bx	lr
.Ltmp3:
	.p2align	2
...
.LCPI1_0:
	.long	deg2rad_Y
.Lfunc_end1:
	.size	deg2rad_return, .Lfunc_end1-deg2rad_return
	.cfi_endproc
	.cantunwind
	.fnend
                                        @ -- End function
	.globl	deg2rad_main                    @ -- Begin function deg2rad_main
	.p2align	2
	.type	deg2rad_main,%function
	.code	32                              @ @deg2rad_main
deg2rad_main:
.Lfunc_begin2:
	.loc	1 77 0 is_stmt 1                @ deg2rad/deg2rad.c:77:0
	.fnstart
	.cfi_startproc
@ %bb.0:                                @ %entry
...
.Ltmp4:
	.loc	1 80 37 prologue_end            @ deg2rad/deg2rad.c:80:37
	mov	r1, r4
.Ltmp5:
	.loc	1 0 0 is_stmt 0                 @ deg2rad/deg2rad.c:0:0
	str	r0, [r7]
.Ltmp6:
	.loc	1 80 37                         @ deg2rad/deg2rad.c:80:37
	bl	__lesf2
.Ltmp7:
	.loc	1 80 3                          @ deg2rad/deg2rad.c:80:3
	cmp	r0, #0
.Ltmp8:
	.loc	1 82 1 is_stmt 1                @ deg2rad/deg2rad.c:82:1
	popgt	{r4, r5, r6, r7, r8, r10, r11, lr}
	bxgt	lr
.LBB2_2:                                @ %for.body
                                        @   in Loop: Header=BB2_1 Depth=1
.Ltmp9:
	.loc	1 81 18                         @ deg2rad/deg2rad.c:81:18
	ldr	r0, [r7]
	mov	r1, r8
	bl	__mulsf3
	mov	r1, r6
	bl	__divsf3
	mov	r1, r0
	.loc	1 81 15 is_stmt 0               @ deg2rad/deg2rad.c:81:15
	ldr	r0, [r5]
	bl	__addsf3
	str	r0, [r5]
	.loc	1 80 58 is_stmt 1               @ deg2rad/deg2rad.c:80:58
	ldr	r0, [r7]
	mov	r1, #1065353216
	bl	__addsf3
	b	.LBB2_1
.Ltmp10:
	.p2align	2
@ %bb.3:
	.loc	1 0 58 is_stmt 0                @ deg2rad/deg2rad.c:0:58
.LCPI2_0:
	.long	deg2rad_X
.LCPI2_1:
	.long	1078523331                      @ 0x4048f5c3
.LCPI2_2:
	.long	deg2rad_Y
.Lfunc_end2:
	.size	deg2rad_main, .Lfunc_end2-deg2rad_main
	.cfi_endproc
	.cantunwind
	.fnend
                                        @ -- End function
...
main:
.Lfunc_begin3:
	.loc	1 86 0 is_stmt 1                @ deg2rad/deg2rad.c:86:0
	.fnstart
	.cfi_startproc
@ %bb.0:                                @ %entry
	push	{r11, lr}
	...
	.cfi_def_cfa_register r11
.Ltmp11:
	.loc	1 87 3 prologue_end             @ deg2rad/deg2rad.c:87:3
	bl	deg2rad_init
	.loc	1 88 3                          @ deg2rad/deg2rad.c:88:3
	bl	deg2rad_main
	.loc	1 89 10                         @ deg2rad/deg2rad.c:89:10
	bl	deg2rad_return
	.loc	1 89 3 is_stmt 0                @ deg2rad/deg2rad.c:89:3
	pop	{r11, lr}
	bx	lr
.Ltmp12:
.Lfunc_end3:
...
.Lfunc_end43:
	...
	.fnend
                                        @ -- End function
	.type	deg2rad_X,%object               @ @deg2rad_X
	.bss
	.globl	deg2rad_X
	.p2align	2
deg2rad_X:
	...
	.type	deg2rad_Y,%object               @ @deg2rad_Y
	.globl	deg2rad_Y
	.p2align	2
deg2rad_Y:
	.long	0x00000000                      @ float 0
...
.Ldebug_info_start0:
	...
	.byte	1                               @ Abbrev [1] 0xc:0x78 DW_TAG_compile_unit
	...
	.byte	49                              @ DW_AT_decl_line
                                        @ DW_AT_prototyped
                                        @ DW_AT_external
	.byte	5                               @ Abbrev [5] 0x4c:0x19 DW_TAG_subprogram
	.byte	3                               @ DW_AT_low_pc
	...
	.long	127                             @ DW_AT_type
                                        @ DW_AT_external
	.byte	6                               @ Abbrev [6] 0x5b:0x9 DW_TAG_variable
	...
	.byte	4                               @ Abbrev [4] 0x65:0xb DW_TAG_subprogram
	.byte	4                               @ DW_AT_low_pc
	...
	.byte	76                              @ DW_AT_decl_line
                                        @ DW_AT_prototyped
                                        @ DW_AT_external
	.byte	7                               @ Abbrev [7] 0x70:0xf DW_TAG_subprogram
	.byte	5                               @ DW_AT_low_pc
	...
	.long	127                             @ DW_AT_type
                                        @ DW_AT_external
	.byte	3                               @ Abbrev [3] 0x7f:0x4 DW_TAG_base_type
	.byte	48                              @ DW_AT_name
...
.Ldebug_info_start1:
	...
	.byte	4                               @ Address Size (in bytes)
	.long	.debug_abbrev                   @ Offset Into Abbrev. Section
	.byte	8                               @ Abbrev [8] 0xc:0x1b DW_TAG_compile_unit
...
.Linfo_string1:
	.asciz	"/workspaces/llvmta/testcases/singletest/deg2rad/deg2rad.c" @ string offset=100
.Linfo_string2:
	.asciz	"/workspaces/llvmta/testcases/singletest/cubic" @ string offset=158
.Linfo_string3:
	.asciz	"deg2rad_X"                     @ string offset=204
.Linfo_string4:
	.asciz	"float"                         @ string offset=214
.Linfo_string5:
	.asciz	"deg2rad_Y"                     @ string offset=220
.Linfo_string6:
	.asciz	"clang version 14.0.6 (git@gitlab.tu-dortmund.de:f4-ls12-daes/llvmta/llvmta.git 64262528b05c9d91a76d9ec1ec1045982f385529)" @ string offset=230
.Linfo_string7:
	.asciz	"../absvdi2.c"                  @ string offset=351
.Linfo_string8:
	.asciz	"/workspaces/llvmta/testcases/libraries/builtinsint/buildarmv4" @ string offset=364
.Linfo_string9:
	.asciz	"../int_util.c"                 @ string offset=426
.Linfo_string10:
	.asciz	"../absvsi2.c"                  @ string offset=440
.Linfo_string11:
	.asciz	"../addvdi3.c"                  @ string offset=453
.Linfo_string12:
	.asciz	"../addvsi3.c"                  @ string offset=466
.Linfo_string13:
	.asciz	"../ashldi3.c"                  @ string offset=479
.Linfo_string14:
	.asciz	"../ashrdi3.c"                  @ string offset=492
.Linfo_string15:
	.asciz	"../clzdi2.c"                   @ string offset=505
.Linfo_string16:
	.asciz	"../clzsi2.c"                   @ string offset=517
.Linfo_string17:
	.asciz	"../cmpdi2.c"                   @ string offset=529
.Linfo_string18:
	.asciz	"../ctzdi2.c"                   @ string offset=541
.Linfo_string19:
	.asciz	"../ctzsi2.c"                   @ string offset=553
.Linfo_string20:
	.asciz	"../divdi3.c"                   @ string offset=565
.Linfo_string21:
	.asciz	"../udivmoddi4.c"               @ string offset=577
.Linfo_string22:
	.asciz	"../divmoddi4.c"                @ string offset=593
.Linfo_string23:
	.asciz	"../divmodsi4.c"                @ string offset=608
.Linfo_string24:
	.asciz	"../divsi3.c"                   @ string offset=623
.Linfo_string25:
	.asciz	"../ffsdi2.c"                   @ string offset=635
.Linfo_string26:
	.asciz	"../ffssi2.c"                   @ string offset=647
.Linfo_string27:
	.asciz	"../lshrdi3.c"                  @ string offset=659
.Linfo_string28:
	.asciz	"../moddi3.c"                   @ string offset=672
.Linfo_string29:
	.asciz	"../modsi3.c"                   @ string offset=684
.Linfo_string30:
	.asciz	"../mulvdi3.c"                  @ string offset=696
.Linfo_string31:
	.asciz	"../mulvsi3.c"                  @ string offset=709
.Linfo_string32:
	.asciz	"../paritydi2.c"                @ string offset=722
.Linfo_string33:
	.asciz	"../paritysi2.c"                @ string offset=737
.Linfo_string34:
	.asciz	"../popcountdi2.c"              @ string offset=752
.Linfo_string35:
	.asciz	"../popcountsi2.c"              @ string offset=769
.Linfo_string36:
	.asciz	"../subvdi3.c"                  @ string offset=786
.Linfo_string37:
	.asciz	"../subvsi3.c"                  @ string offset=799
.Linfo_string38:
	.asciz	"../ucmpdi2.c"                  @ string offset=812
.Linfo_string39:
	.asciz	"../udivdi3.c"                  @ string offset=825
.Linfo_string40:
	.asciz	"../udivmodsi4.c"               @ string offset=838
.Linfo_string41:
	.asciz	"../udivsi3.c"                  @ string offset=854
.Linfo_string42:
	.asciz	"../umoddi3.c"                  @ string offset=867
.Linfo_string43:
	.asciz	"../umodsi3.c"                  @ string offset=880
.Linfo_string44:
	.asciz	"../memory.c"                   @ string offset=893
.Linfo_string45:
	.asciz	"/workspaces/llvmta/testcases/libraries/builtinsstd/buildarmv4" @ string offset=905
.Linfo_string46:
	.asciz	"deg2rad_init"                  @ string offset=967
.Linfo_string47:
	.asciz	"deg2rad_return"                @ string offset=980
.Linfo_string48:
	.asciz	"int"                           @ string offset=995
.Linfo_string49:
	.asciz	"deg2rad_main"                  @ string offset=999
.Linfo_string50:
	.asciz	"main"                          @ string offset=1012
.Linfo_string51:
	.asciz	"temp"                          @ string offset=1017
	.section	.debug_str_offsets,"",%progbits
	.long	.Linfo_string0
	.long	.Linfo_string1
	.long	.Linfo_string2
