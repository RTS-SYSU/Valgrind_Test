...
deg2rad_init:
.Lfunc_begin0:
	.file	1 "/workspaces/llvmta/testcases" "batchtest/deg2rad/deg2rad.c" md5 0x0fe4ba11c47aee6bb7dafa1609b02d47
	.loc	1 50 0                          @ batchtest/deg2rad/deg2rad.c:50:0
	.fnstart
	.cfi_sections .debug_frame
	.cfi_startproc
@ %bb.0:                                @ %entry
	.loc	1 51 13 prologue_end            @ batchtest/deg2rad/deg2rad.c:51:13
	ldr	r1, .LCPI0_0
	mov	r0, #0
	str	r0, [r1]
	.loc	1 52 13                         @ batchtest/deg2rad/deg2rad.c:52:13
	ldr	r1, .LCPI0_1
	str	r0, [r1]
	.loc	1 53 1                          @ batchtest/deg2rad/deg2rad.c:53:1
	bx	lr
.Ltmp0:
	.p2align	2
@ %bb.1:
	.loc	1 0 1 is_stmt 0                 @ batchtest/deg2rad/deg2rad.c:0:1
.LCPI0_0:
	.long	deg2rad_X
.LCPI0_1:
	.long	deg2rad_Y
...
deg2rad_return:
.Lfunc_begin1:
	.loc	1 61 0 is_stmt 1                @ batchtest/deg2rad/deg2rad.c:61:0
	.fnstart
	.cfi_startproc
@ %bb.0:                                @ %entry
	sub	sp, sp, #4
...
.Ltmp1:
	.loc	1 62 14 prologue_end            @ batchtest/deg2rad/deg2rad.c:62:14
	ldr	r0, .LCPI1_0
	vldr	s0, [r0]
	vcvt.s32.f32	s0, s0
	vmov	r0, s0
	mov	r1, #109
	orr	r1, r1, #1024
	.loc	1 64 8                          @ batchtest/deg2rad/deg2rad.c:64:8
	cmp	r0, r1
	bne	.LBB1_2
	b	.LBB1_1
.LBB1_1:                                @ %if.then
	.loc	1 0 8 is_stmt 0                 @ batchtest/deg2rad/deg2rad.c:0:8
	mov	r0, #0
	str	r0, [sp]                        @ 4-byte Spill
	.loc	1 65 5 is_stmt 1                @ batchtest/deg2rad/deg2rad.c:65:5
	b	.LBB1_3
.LBB1_2:                                @ %if.else
	.loc	1 0 5 is_stmt 0                 @ batchtest/deg2rad/deg2rad.c:0:5
	mvn	r0, #0
	str	r0, [sp]                        @ 4-byte Spill
	.loc	1 67 5 is_stmt 1                @ batchtest/deg2rad/deg2rad.c:67:5
	b	.LBB1_3
.LBB1_3:                                @ %return
	.loc	1 0 0 is_stmt 0                 @ batchtest/deg2rad/deg2rad.c:0:0
	ldr	r0, [sp]                        @ 4-byte Reload
	.loc	1 69 1 is_stmt 1                @ batchtest/deg2rad/deg2rad.c:69:1
	add	sp, sp, #4
	bx	lr
.Ltmp2:
	.p2align	2
...
deg2rad_main:
.Lfunc_begin2:
	.loc	1 77 0 is_stmt 1                @ batchtest/deg2rad/deg2rad.c:77:0
	.fnstart
	.cfi_startproc
@ %bb.0:                                @ %entry
	sub	sp, sp, #4
...
.Ltmp3:
	.loc	1 80 9 prologue_end             @ batchtest/deg2rad/deg2rad.c:80:9
	b	.LBB2_1
.LBB2_1:                                @ %for.cond
	...
	vstr	s0, [r0]
	vldr	s2, .LCPI2_2
	.loc	1 80 3                          @ batchtest/deg2rad/deg2rad.c:80:3
	vcmp.f32	s0, s2
...
.LBB2_2:                                @ %for.body
	...
	.loc	1 81 18 is_stmt 1               @ batchtest/deg2rad/deg2rad.c:81:18
	ldr	r0, .LCPI2_1
	vldr	s0, [r0]
	vldr	s2, .LCPI2_3
	vmul.f32	s0, s0, s2
	vldr	s2, .LCPI2_4
	vdiv.f32	s2, s0, s2
	.loc	1 81 15 is_stmt 0               @ batchtest/deg2rad/deg2rad.c:81:15
	ldr	r0, .LCPI2_5
	vldr	s0, [r0]
	vadd.f32	s0, s0, s2
	vstr	s0, [r0]
	.loc	1 81 5                          @ batchtest/deg2rad/deg2rad.c:81:5
	b	.LBB2_3
.LBB2_3:                                @ %for.inc
                                        @   in Loop: Header=BB2_1 Depth=1
	.loc	1 80 57 is_stmt 1               @ batchtest/deg2rad/deg2rad.c:80:57
	ldr	r0, .LCPI2_1
	vldr	s0, [r0]
	vldr	s2, .LCPI2_6
	vadd.f32	s0, s0, s2
	vstr	s0, [sp]                        @ 4-byte Spill
	.loc	1 80 3 is_stmt 0                @ batchtest/deg2rad/deg2rad.c:80:3
	b	.LBB2_1
.LBB2_4:                                @ %for.end
	.loc	1 82 1 is_stmt 1                @ batchtest/deg2rad/deg2rad.c:82:1
	add	sp, sp, #4
	bx	lr
.Ltmp4:
	.p2align	2
...
main:
.Lfunc_begin3:
	.loc	1 86 0 is_stmt 1                @ batchtest/deg2rad/deg2rad.c:86:0
	.fnstart
	.cfi_startproc
@ %bb.0:                                @ %entry
	push	{r11, lr}
...
.Ltmp5:
	.loc	1 87 3 prologue_end             @ batchtest/deg2rad/deg2rad.c:87:3
	bl	deg2rad_init
	.loc	1 88 3                          @ batchtest/deg2rad/deg2rad.c:88:3
	bl	deg2rad_main
	.loc	1 89 10                         @ batchtest/deg2rad/deg2rad.c:89:10
	bl	deg2rad_return
	.loc	1 89 3 is_stmt 0                @ batchtest/deg2rad/deg2rad.c:89:3
	pop	{r11, lr}
	bx	lr
.Ltmp6:
.Lfunc_end3:
...
.Linfo_string1:
	.asciz	"/workspaces/llvmta/testcases/batchtest/deg2rad/deg2rad.c" @ string offset=100
.Linfo_string2:
	.asciz	"/workspaces/llvmta/testcases/tmp.utssoyN4Ck" @ string offset=157
.Linfo_string3:
