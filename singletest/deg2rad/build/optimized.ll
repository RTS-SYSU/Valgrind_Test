...
define dso_local arm_aapcs_vfpcc void @deg2rad_init() #0 !dbg !125 {
entry:
  store float 0.000000e+00, float* @deg2rad_X, align 4, !dbg !129
  store float 0.000000e+00, float* @deg2rad_Y, align 4, !dbg !130
  ret void, !dbg !131
}

; Function Attrs: noinline nounwind
define dso_local arm_aapcs_vfpcc i32 @deg2rad_return() #0 !dbg !132 {
entry:
  %0 = load float, float* @deg2rad_Y, align 4, !dbg !133
  %conv = fptosi float %0 to i32, !dbg !133
  %cmp = icmp eq i32 %conv, 1133, !dbg !134
...
; Function Attrs: noinline nounwind
define dso_local arm_aapcs_vfpcc void @deg2rad_main() #0 !dbg !140 {
entry:
  br label %for.cond, !dbg !141

for.cond:                                         ; preds = %for.inc, %entry
  %storemerge = phi float [ 0.000000e+00, %entry ], [ %add1, %for.inc ], !dbg !142
  store float %storemerge, float* @deg2rad_X, align 4, !dbg !142
  %cmp = fcmp ugt float %storemerge, 1.000000e+01, !dbg !143
  br i1 %cmp, label %for.end, label %for.body, !dbg !144

for.body:                                         ; preds = %for.cond
  %0 = load float, float* @deg2rad_X, align 4, !dbg !145
  %mul = fmul float %0, 0x40091EB860000000, !dbg !145
  %div = fdiv float %mul, 1.800000e+02, !dbg !145
  %1 = load float, float* @deg2rad_Y, align 4, !dbg !146
  %add = fadd float %1, %div, !dbg !146
  store float %add, float* @deg2rad_Y, align 4, !dbg !146
  br label %for.inc, !dbg !147

for.inc:                                          ; preds = %for.body
  %2 = load float, float* @deg2rad_X, align 4, !dbg !148
  %add1 = fadd float %2, 1.000000e+00, !dbg !148
...
entry:
  call arm_aapcs_vfpcc void @deg2rad_init() #4, !dbg !153
  call arm_aapcs_vfpcc void @deg2rad_main() #4, !dbg !154
  %call = call arm_aapcs_vfpcc i32 @deg2rad_return() #4, !dbg !155
...
!125 = distinct !DISubprogram(name: "deg2rad_init", scope: !126, file: !126, line: 49, type: !127, scopeLine: 50, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !128)
!126 = !DIFile(filename: "batchtest/deg2rad/deg2rad.c", directory: "/workspaces/llvmta/testcases", checksumkind: CSK_MD5, checksum: "0fe4ba11c47aee6bb7dafa1609b02d47")
!127 = !DISubroutineType(types: !128)
!128 = !{}
!129 = !DILocation(line: 51, column: 13, scope: !125)
!130 = !DILocation(line: 52, column: 13, scope: !125)
!131 = !DILocation(line: 53, column: 1, scope: !125)
!132 = distinct !DISubprogram(name: "deg2rad_return", scope: !126, file: !126, line: 60, type: !127, scopeLine: 61, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !128)
!133 = !DILocation(line: 62, column: 14, scope: !132)
!134 = !DILocation(line: 64, column: 13, scope: !132)
!135 = !DILocation(line: 64, column: 8, scope: !132)
!136 = !DILocation(line: 65, column: 5, scope: !132)
!137 = !DILocation(line: 67, column: 5, scope: !132)
!138 = !DILocation(line: 0, scope: !132)
!139 = !DILocation(line: 69, column: 1, scope: !132)
!140 = distinct !DISubprogram(name: "deg2rad_main", scope: !126, file: !126, line: 76, type: !127, scopeLine: 77, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !128)
!141 = !DILocation(line: 80, column: 9, scope: !140)
!142 = !DILocation(line: 0, scope: !140)
!143 = !DILocation(line: 80, column: 37, scope: !140)
!144 = !DILocation(line: 80, column: 3, scope: !140)
!145 = !DILocation(line: 81, column: 18, scope: !140)
!146 = !DILocation(line: 81, column: 15, scope: !140)
!147 = !DILocation(line: 81, column: 5, scope: !140)
!148 = !DILocation(line: 80, column: 57, scope: !140)
!149 = distinct !{!149, !144, !145, !150}
!150 = !{!"llvm.loop.mustprogress"}
!151 = !DILocation(line: 82, column: 1, scope: !140)
!152 = distinct !DISubprogram(name: "main", scope: !126, file: !126, line: 85, type: !127, scopeLine: 86, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !128)
!153 = !DILocation(line: 87, column: 3, scope: !152)
!154 = !DILocation(line: 88, column: 3, scope: !152)
!155 = !DILocation(line: 89, column: 10, scope: !152)
!156 = !DILocation(line: 89, column: 3, scope: !152)
