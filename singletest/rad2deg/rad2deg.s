	...
	.file	"llvm-link"
	.file	1 "/workspaces/llvmta/testcases/singletest" "rad2deg/rad2deg.c"
...
rad2deg_init:
.Lfunc_begin0:
	.loc	1 51 0                          @ rad2deg/rad2deg.c:51:0
	.fnstart
	.cfi_sections .debug_frame
	.cfi_startproc
@ %bb.0:                                @ %entry
	.loc	1 53 13 prologue_end            @ rad2deg/rad2deg.c:53:13
	ldr	r0, .LCPI0_0
	mov	r1, #0
	str	r1, [r0]
	.loc	1 52 13                         @ rad2deg/rad2deg.c:52:13
	ldr	r0, .LCPI0_1
	str	r1, [r0]
	.loc	1 54 1                          @ rad2deg/rad2deg.c:54:1
	bx	lr
.Ltmp0:
	.p2align	2
@ %bb.1:
	.loc	1 0 1 is_stmt 0                 @ rad2deg/rad2deg.c:0:1
.LCPI0_0:
	.long	rad2deg_Y
.LCPI0_1:
	.long	rad2deg_X
.Lfunc_end0:
	.size	rad2deg_init, .Lfunc_end0-rad2deg_init
	.cfi_endproc
	.cantunwind
	.fnend
                                        @ -- End function
...
rad2deg_return:
.Lfunc_begin1:
	.loc	1 62 0 is_stmt 1                @ rad2deg/rad2deg.c:62:0
	.fnstart
	.cfi_startproc
@ %bb.0:                                @ %entry
	push	{r11, lr}
...
.Ltmp1:
	.loc	1 63 14 prologue_end            @ rad2deg/rad2deg.c:63:14
	ldr	r0, .LCPI1_0
	ldr	r0, [r0]
	bl	__fixsfsi
	mov	r2, #108
	mov	r1, r0
.Ltmp2:
	@DEBUG_VALUE: rad2deg_return:temp <- $r1
	.loc	1 0 14 is_stmt 0                @ rad2deg/rad2deg.c:0:14
	mov	r0, #0
	orr	r2, r2, #64512
	.loc	1 65 8 is_stmt 1                @ rad2deg/rad2deg.c:65:8
	cmp	r1, r2
	mvnne	r0, #0
	.loc	1 69 1                          @ rad2deg/rad2deg.c:69:1
	pop	{r11, lr}
	bx	lr
.Ltmp3:
	.p2align	2
...
.LCPI1_0:
	.long	rad2deg_Y
.Lfunc_end1:
	.size	rad2deg_return, .Lfunc_end1-rad2deg_return
	.cfi_endproc
	.cantunwind
	.fnend
                                        @ -- End function
...
rad2deg_main:
.Lfunc_begin2:
	.loc	1 77 0 is_stmt 1                @ rad2deg/rad2deg.c:77:0
	.fnstart
	.cfi_startproc
@ %bb.0:                                @ %entry
...
.Ltmp4:
	.loc	1 79 37 prologue_end            @ rad2deg/rad2deg.c:79:37
	mov	r1, r4
.Ltmp5:
	.loc	1 0 0 is_stmt 0                 @ rad2deg/rad2deg.c:0:0
	str	r0, [r5]
.Ltmp6:
	.loc	1 79 37                         @ rad2deg/rad2deg.c:79:37
	bl	__lesf2
.Ltmp7:
	.loc	1 79 3                          @ rad2deg/rad2deg.c:79:3
	cmp	r0, #0
.Ltmp8:
	.loc	1 81 1 is_stmt 1                @ rad2deg/rad2deg.c:81:1
	popgt	{r4, r5, r6, r7, r8, r9, r11, lr}
	bxgt	lr
.LBB2_2:                                @ %for.body
                                        @   in Loop: Header=BB2_1 Depth=1
.Ltmp9:
	.loc	1 80 18                         @ rad2deg/rad2deg.c:80:18
	ldr	r0, [r5]
	mov	r1, r8
	bl	__mulsf3
	mov	r1, r9
	bl	__divsf3
	mov	r1, r0
	.loc	1 80 15 is_stmt 0               @ rad2deg/rad2deg.c:80:15
	ldr	r0, [r6]
	bl	__addsf3
	str	r0, [r6]
	.loc	1 79 70 is_stmt 1               @ rad2deg/rad2deg.c:79:70
	ldr	r0, [r5]
	mov	r1, r7
	bl	__addsf3
	b	.LBB2_1
.Ltmp10:
	.p2align	2
@ %bb.3:
	.loc	1 0 70 is_stmt 0                @ rad2deg/rad2deg.c:0:70
.LCPI2_0:
	.long	rad2deg_X
.LCPI2_1:
	.long	1086911941                      @ 0x40c8f5c5
.LCPI2_2:
	.long	1078523331                      @ 0x4048f5c3
.LCPI2_3:
	.long	rad2deg_Y
.LCPI2_4:
	.long	1015998375                      @ 0x3c8ee7a7
.Lfunc_end2:
	.size	rad2deg_main, .Lfunc_end2-rad2deg_main
	.cfi_endproc
	.cantunwind
	.fnend
                                        @ -- End function
...
main:
.Lfunc_begin3:
	.loc	1 85 0 is_stmt 1                @ rad2deg/rad2deg.c:85:0
	.fnstart
	.cfi_startproc
@ %bb.0:                                @ %entry
	push	{r11, lr}
	...
	.cfi_def_cfa_register r11
.Ltmp11:
	.loc	1 86 3 prologue_end             @ rad2deg/rad2deg.c:86:3
	bl	rad2deg_init
	.loc	1 87 3                          @ rad2deg/rad2deg.c:87:3
	bl	rad2deg_main
	.loc	1 88 10                         @ rad2deg/rad2deg.c:88:10
	bl	rad2deg_return
	.loc	1 88 3 is_stmt 0                @ rad2deg/rad2deg.c:88:3
	pop	{r11, lr}
	bx	lr
.Ltmp12:
.Lfunc_end3:
...
.Linfo_string1:
	.asciz	"/workspaces/llvmta/testcases/singletest/rad2deg/rad2deg.c" @ string offset=100
.Linfo_string2:
	.asciz	"/workspaces/llvmta/testcases/singletest/prime" @ string offset=158
.Linfo_string3:
	.asciz	"rad2deg_X"                     @ string offset=204
.Linfo_string4:
	.asciz	"float"                         @ string offset=214
.Linfo_string5:
	.asciz	"rad2deg_Y"                     @ string offset=220
.Linfo_string6:
...
.Linfo_string46:
	.asciz	"rad2deg_init"                  @ string offset=967
.Linfo_string47:
	.asciz	"rad2deg_return"                @ string offset=980
.Linfo_string48:
	.asciz	"int"                           @ string offset=995
.Linfo_string49:
	.asciz	"rad2deg_main"                  @ string offset=999
.Linfo_string50:
