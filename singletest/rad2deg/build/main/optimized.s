...
rad2deg_init:
.Lfunc_begin0:
	.file	1 "/workspaces/llvmta/testcases" "batchtest/rad2deg/rad2deg.c" md5 0x4caa21133271f14cd04f199ea1dac6c5
	.loc	1 45 0                          @ batchtest/rad2deg/rad2deg.c:45:0
	.fnstart
	.cfi_sections .debug_frame
	.cfi_startproc
@ %bb.0:                                @ %entry
	.loc	1 46 13 prologue_end            @ batchtest/rad2deg/rad2deg.c:46:13
	ldr	r1, .LCPI0_0
	mov	r0, #0
	str	r0, [r1]
	.loc	1 47 13                         @ batchtest/rad2deg/rad2deg.c:47:13
	ldr	r1, .LCPI0_1
	str	r0, [r1]
	.loc	1 48 1                          @ batchtest/rad2deg/rad2deg.c:48:1
	bx	lr
.Ltmp0:
	.p2align	2
@ %bb.1:
	.loc	1 0 1 is_stmt 0                 @ batchtest/rad2deg/rad2deg.c:0:1
.LCPI0_0:
	.long	rad2deg_X
.LCPI0_1:
	.long	rad2deg_Y
...
rad2deg_return:
.Lfunc_begin1:
	.loc	1 54 0 is_stmt 1                @ batchtest/rad2deg/rad2deg.c:54:0
	.fnstart
	.cfi_startproc
@ %bb.0:                                @ %entry
	sub	sp, sp, #4
...
.Ltmp1:
	.loc	1 55 14 prologue_end            @ batchtest/rad2deg/rad2deg.c:55:14
	ldr	r0, .LCPI1_0
	vldr	s0, [r0]
	vcvt.s32.f32	s0, s0
	vmov	r0, s0
	mov	r1, #108
	orr	r1, r1, #64512
	.loc	1 57 7                          @ batchtest/rad2deg/rad2deg.c:57:7
	cmp	r0, r1
	bne	.LBB1_2
	b	.LBB1_1
.LBB1_1:                                @ %if.then
	.loc	1 0 7 is_stmt 0                 @ batchtest/rad2deg/rad2deg.c:0:7
	mov	r0, #0
	str	r0, [sp]                        @ 4-byte Spill
	.loc	1 58 5 is_stmt 1                @ batchtest/rad2deg/rad2deg.c:58:5
	b	.LBB1_3
.LBB1_2:                                @ %if.else
	.loc	1 0 5 is_stmt 0                 @ batchtest/rad2deg/rad2deg.c:0:5
	mvn	r0, #0
	str	r0, [sp]                        @ 4-byte Spill
	.loc	1 60 5 is_stmt 1                @ batchtest/rad2deg/rad2deg.c:60:5
	b	.LBB1_3
.LBB1_3:                                @ %return
	.loc	1 0 0 is_stmt 0                 @ batchtest/rad2deg/rad2deg.c:0:0
	ldr	r0, [sp]                        @ 4-byte Reload
	.loc	1 61 1 is_stmt 1                @ batchtest/rad2deg/rad2deg.c:61:1
	add	sp, sp, #4
	bx	lr
.Ltmp2:
	.p2align	2
...
rad2deg_main:
.Lfunc_begin2:
	.loc	1 67 0 is_stmt 1                @ batchtest/rad2deg/rad2deg.c:67:0
	.fnstart
	.cfi_startproc
@ %bb.0:                                @ %entry
	sub	sp, sp, #4
...
.Ltmp3:
	.loc	1 68 45 prologue_end            @ batchtest/rad2deg/rad2deg.c:68:45
	b	.LBB2_1
.LBB2_1:                                @ %for.cond
	...
	vstr	s0, [r0]
	vldr	s2, .LCPI2_2
	.loc	1 68 40                         @ batchtest/rad2deg/rad2deg.c:68:40
	vcmp.f32	s0, s2
...
.LBB2_2:                                @ %for.body
	...
	.loc	1 71 20 is_stmt 1               @ batchtest/rad2deg/rad2deg.c:71:20
	ldr	r0, .LCPI2_1
	vldr	s0, [r0]
	vldr	s2, .LCPI2_3
	vmul.f32	s0, s0, s2
	vldr	s2, .LCPI2_4
	vdiv.f32	s2, s0, s2
	.loc	1 71 17 is_stmt 0               @ batchtest/rad2deg/rad2deg.c:71:17
	ldr	r0, .LCPI2_5
	vldr	s0, [r0]
	vadd.f32	s0, s0, s2
	vstr	s0, [r0]
	.loc	1 71 7                          @ batchtest/rad2deg/rad2deg.c:71:7
	b	.LBB2_3
.LBB2_3:                                @ %for.inc
                                        @   in Loop: Header=BB2_1 Depth=1
	.loc	1 70 55 is_stmt 1               @ batchtest/rad2deg/rad2deg.c:70:55
	ldr	r0, .LCPI2_1
	vldr	s0, [r0]
	vldr	s2, .LCPI2_6
	vadd.f32	s0, s0, s2
	...
	b	.LBB2_1
.LBB2_4:                                @ %for.end
	.loc	1 72 1                          @ batchtest/rad2deg/rad2deg.c:72:1
	add	sp, sp, #4
	bx	lr
.Ltmp4:
	.p2align	2
...
.LCPI2_1:
	.long	rad2deg_X
.LCPI2_2:
	.long	0x3d0ee7a7                      @ float 0.0348888896
.LCPI2_3:
...
main:
.Lfunc_begin3:
	.loc	1 74 0 is_stmt 1                @ batchtest/rad2deg/rad2deg.c:74:0
	.fnstart
	.cfi_startproc
@ %bb.0:                                @ %entry
	push	{r11, lr}
...
.Ltmp5:
	.loc	1 75 3 prologue_end             @ batchtest/rad2deg/rad2deg.c:75:3
	bl	rad2deg_init
	.loc	1 76 3                          @ batchtest/rad2deg/rad2deg.c:76:3
	bl	rad2deg_main
	.loc	1 77 10                         @ batchtest/rad2deg/rad2deg.c:77:10
	bl	rad2deg_return
	.loc	1 77 3 is_stmt 0                @ batchtest/rad2deg/rad2deg.c:77:3
	pop	{r11, lr}
	bx	lr
.Ltmp6:
.Lfunc_end3:
...
.Linfo_string1:
	.asciz	"/workspaces/llvmta/testcases/batchtest/rad2deg/rad2deg.c" @ string offset=100
.Linfo_string2:
	.asciz	"/workspaces/llvmta/testcases/tmp.tIU11NKEri" @ string offset=157
.Linfo_string3:
