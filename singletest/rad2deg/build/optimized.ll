...
define dso_local arm_aapcs_vfpcc void @rad2deg_init() #0 !dbg !125 {
entry:
  store float 0.000000e+00, float* @rad2deg_X, align 4, !dbg !129
  store float 0.000000e+00, float* @rad2deg_Y, align 4, !dbg !130
  ret void, !dbg !131
}

; Function Attrs: noinline nounwind
define dso_local arm_aapcs_vfpcc i32 @rad2deg_return() #0 !dbg !132 {
entry:
  %0 = load float, float* @rad2deg_Y, align 4, !dbg !133
  %conv = fptosi float %0 to i32, !dbg !133
  %cmp = icmp eq i32 %conv, 64620, !dbg !134
...
return:                                           ; preds = %if.else, %if.then
  %retval.0 = phi i32 [ 0, %if.then ], [ -1, %if.else ], !dbg !138
  ret i32 %retval.0, !dbg !139
}

; Function Attrs: noinline nounwind
define dso_local arm_aapcs_vfpcc void @rad2deg_main() #0 !dbg !140 {
entry:
  br label %for.cond, !dbg !141

for.cond:                                         ; preds = %for.inc, %entry
  %storemerge = phi float [ 0.000000e+00, %entry ], [ %add1, %for.inc ], !dbg !142
  store float %storemerge, float* @rad2deg_X, align 4, !dbg !142
  %cmp = fcmp ugt float %storemerge, 0x3FA1DCF4E0000000, !dbg !143
  br i1 %cmp, label %for.end, label %for.body, !dbg !144

for.body:                                         ; preds = %for.cond
  %0 = load float, float* @rad2deg_X, align 4, !dbg !145
  %mul = fmul float %0, 1.800000e+02, !dbg !145
  %div = fdiv float %mul, 0x40091EB860000000, !dbg !145
  %1 = load float, float* @rad2deg_Y, align 4, !dbg !146
  %add = fadd float %1, %div, !dbg !146
  store float %add, float* @rad2deg_Y, align 4, !dbg !146
  br label %for.inc, !dbg !147

for.inc:                                          ; preds = %for.body
  %2 = load float, float* @rad2deg_X, align 4, !dbg !148
  %add1 = fadd float %2, 0x3F91DCF4E0000000, !dbg !148
  br label %for.cond, !dbg !144, !llvm.loop !149
...
; Function Attrs: noinline nounwind
define dso_local arm_aapcs_vfpcc i32 @main() #0 !dbg !152 {
entry:
  call arm_aapcs_vfpcc void @rad2deg_init() #4, !dbg !153
  call arm_aapcs_vfpcc void @rad2deg_main() #4, !dbg !154
  %call = call arm_aapcs_vfpcc i32 @rad2deg_return() #4, !dbg !155
  ret i32 %call, !dbg !156
}

; Function Attrs: noinline nounwind
define dso_local arm_aapcscc i64 @__absvdi2(i64 noundef %a) #1 !dbg !157 {
entry:
...
if.then:                                          ; preds = %entry
  ...
  %s3 = bitcast %union.dwords* %result to %struct.anon*, !dbg !205
  %high = getelementptr inbounds %struct.anon, %struct.anon* %s3, i32 0, i32 1, !dbg !206
...
if.then:                                          ; preds = %entry
  %s = bitcast %union.dwords* %input to %struct.anon*, !dbg !235
  %high = getelementptr inbounds %struct.anon, %struct.anon* %s, i32 0, i32 1, !dbg !236
  %0 = load i32, i32* %high, align 4, !dbg !236
  %shr = ashr i32 %0, 31, !dbg !237
  %s1 = bitcast %union.dwords* %result to %struct.anon*, !dbg !238
  %high2 = getelementptr inbounds %struct.anon, %struct.anon* %s1, i32 0, i32 1, !dbg !239
  store i32 %shr, i32* %high2, align 4, !dbg !240
  %s3 = bitcast %union.dwords* %input to %struct.anon*, !dbg !241
  %high4 = getelementptr inbounds %struct.anon, %struct.anon* %s3, i32 0, i32 1, !dbg !242
...
if.end:                                           ; preds = %if.else
  %s8 = bitcast %union.dwords* %input to %struct.anon*, !dbg !251
  %high9 = getelementptr inbounds %struct.anon, %struct.anon* %s8, i32 0, i32 1, !dbg !252
  %2 = load i32, i32* %high9, align 4, !dbg !252
  %shr10 = ashr i32 %2, %b, !dbg !253
  %s11 = bitcast %union.dwords* %result to %struct.anon*, !dbg !254
  %high12 = getelementptr inbounds %struct.anon, %struct.anon* %s11, i32 0, i32 1, !dbg !255
  store i32 %shr10, i32* %high12, align 4, !dbg !256
  %s13 = bitcast %union.dwords* %input to %struct.anon*, !dbg !257
  %high14 = getelementptr inbounds %struct.anon, %struct.anon* %s13, i32 0, i32 1, !dbg !258
...
entry:
  ...
  %s = bitcast %union.dwords* %x to %struct.anon*, !dbg !273
  %high = getelementptr inbounds %struct.anon, %struct.anon* %s, i32 0, i32 1, !dbg !274
  %0 = load i32, i32* %high, align 4, !dbg !274
  %cmp = icmp eq i32 %0, 0, !dbg !275
  %s1 = bitcast %union.dwords* %x to %struct.anon*, !dbg !276
  %high2 = getelementptr inbounds %struct.anon, %struct.anon* %s1, i32 0, i32 1, !dbg !277
...
entry:
  ...
  %s = bitcast %union.dwords* %x to %struct.anon*, !dbg !318
  %high = getelementptr inbounds %struct.anon, %struct.anon* %s, i32 0, i32 1, !dbg !319
  %0 = load i32, i32* %high, align 4, !dbg !319
  %s2 = bitcast %union.dwords* %y to %struct.anon*, !dbg !320
  %high3 = getelementptr inbounds %struct.anon, %struct.anon* %s2, i32 0, i32 1, !dbg !321
...
if.end:                                           ; preds = %entry
  %s4 = bitcast %union.dwords* %x to %struct.anon*, !dbg !325
  %high5 = getelementptr inbounds %struct.anon, %struct.anon* %s4, i32 0, i32 1, !dbg !326
  %2 = load i32, i32* %high5, align 4, !dbg !326
  %s6 = bitcast %union.dwords* %y to %struct.anon*, !dbg !327
  %high7 = getelementptr inbounds %struct.anon, %struct.anon* %s6, i32 0, i32 1, !dbg !328
...
entry:
  ...
  %s1 = bitcast %union.dwords* %x to %struct.anon*, !dbg !354
  %high = getelementptr inbounds %struct.anon, %struct.anon* %s1, i32 0, i32 1, !dbg !355
...
entry:
  ...
  %s = bitcast %union.dwords* %n to %struct.anon*, !dbg !404
...
if.then:                                          ; preds = %entry
  %s2 = bitcast %union.dwords* %d to %struct.anon*, !dbg !408
  %high3 = getelementptr inbounds %struct.anon, %struct.anon* %s2, i32 0, i32 1, !dbg !409
...
if.then28:                                        ; preds = %if.end23
  %s29 = bitcast %union.dwords* %d to %struct.anon*, !dbg !433
  %high30 = getelementptr inbounds %struct.anon, %struct.anon* %s29, i32 0, i32 1, !dbg !434
...
if.then35:                                        ; preds = %if.then33
  %s36 = bitcast %union.dwords* %n to %struct.anon*, !dbg !438
  %high37 = getelementptr inbounds %struct.anon, %struct.anon* %s36, i32 0, i32 1, !dbg !439
...
if.end42:                                         ; preds = %if.then35, %if.then33
  %s43 = bitcast %union.dwords* %n to %struct.anon*, !dbg !445
  %high44 = getelementptr inbounds %struct.anon, %struct.anon* %s43, i32 0, i32 1, !dbg !446
...
if.then56:                                        ; preds = %if.then54
  %s57 = bitcast %union.dwords* %n to %struct.anon*, !dbg !455
  %high58 = getelementptr inbounds %struct.anon, %struct.anon* %s57, i32 0, i32 1, !dbg !456
  %14 = load i32, i32* %high58, align 4, !dbg !456
  %s59 = bitcast %union.dwords* %d to %struct.anon*, !dbg !457
  %high60 = getelementptr inbounds %struct.anon, %struct.anon* %s59, i32 0, i32 1, !dbg !458
  %15 = load i32, i32* %high60, align 4, !dbg !458
  %rem61 = urem i32 %14, %15, !dbg !459
  %s62 = bitcast %union.dwords* %r to %struct.anon*, !dbg !460
  %high63 = getelementptr inbounds %struct.anon, %struct.anon* %s62, i32 0, i32 1, !dbg !461
...
if.end67:                                         ; preds = %if.then56, %if.then54
  %s68 = bitcast %union.dwords* %n to %struct.anon*, !dbg !468
  %high69 = getelementptr inbounds %struct.anon, %struct.anon* %s68, i32 0, i32 1, !dbg !469
  %17 = load i32, i32* %high69, align 4, !dbg !469
  %s70 = bitcast %union.dwords* %d to %struct.anon*, !dbg !470
  %high71 = getelementptr inbounds %struct.anon, %struct.anon* %s70, i32 0, i32 1, !dbg !471
...
if.end74:                                         ; preds = %if.end49
  %s75 = bitcast %union.dwords* %d to %struct.anon*, !dbg !475
  %high76 = getelementptr inbounds %struct.anon, %struct.anon* %s75, i32 0, i32 1, !dbg !476
  %19 = load i32, i32* %high76, align 4, !dbg !476
  %s77 = bitcast %union.dwords* %d to %struct.anon*, !dbg !477
  %high78 = getelementptr inbounds %struct.anon, %struct.anon* %s77, i32 0, i32 1, !dbg !478
...
if.then83:                                        ; preds = %if.then81
  ...
  %s88 = bitcast %union.dwords* %n to %struct.anon*, !dbg !487
  %high89 = getelementptr inbounds %struct.anon, %struct.anon* %s88, i32 0, i32 1, !dbg !488
  %22 = load i32, i32* %high89, align 4, !dbg !488
  %s90 = bitcast %union.dwords* %d to %struct.anon*, !dbg !489
  %high91 = getelementptr inbounds %struct.anon, %struct.anon* %s90, i32 0, i32 1, !dbg !490
  %23 = load i32, i32* %high91, align 4, !dbg !490
  %sub92 = add i32 %23, -1, !dbg !491
  %and93 = and i32 %22, %sub92, !dbg !492
  %s94 = bitcast %union.dwords* %r to %struct.anon*, !dbg !493
  %high95 = getelementptr inbounds %struct.anon, %struct.anon* %s94, i32 0, i32 1, !dbg !494
...
if.end97:                                         ; preds = %if.then83, %if.then81
  %s98 = bitcast %union.dwords* %n to %struct.anon*, !dbg !499
  %high99 = getelementptr inbounds %struct.anon, %struct.anon* %s98, i32 0, i32 1, !dbg !500
  %25 = load i32, i32* %high99, align 4, !dbg !500
  %s100 = bitcast %union.dwords* %d to %struct.anon*, !dbg !501
  %high101 = getelementptr inbounds %struct.anon, %struct.anon* %s100, i32 0, i32 1, !dbg !502
...
if.end103:                                        ; preds = %if.end74
  %s104 = bitcast %union.dwords* %d to %struct.anon*, !dbg !507
  %high105 = getelementptr inbounds %struct.anon, %struct.anon* %s104, i32 0, i32 1, !dbg !508
  %28 = load i32, i32* %high105, align 4, !dbg !508
  %29 = call i32 @llvm.ctlz.i32(i32 %28, i1 false), !dbg !509, !range !281
  %s106 = bitcast %union.dwords* %n to %struct.anon*, !dbg !510
  %high107 = getelementptr inbounds %struct.anon, %struct.anon* %s106, i32 0, i32 1, !dbg !511
...
if.end116:                                        ; preds = %if.end103
  ...
  %s122 = bitcast %union.dwords* %q to %struct.anon*, !dbg !527
  %high123 = getelementptr inbounds %struct.anon, %struct.anon* %s122, i32 0, i32 1, !dbg !528
  store i32 %shl, i32* %high123, align 4, !dbg !529
  %s124 = bitcast %union.dwords* %n to %struct.anon*, !dbg !530
  %high125 = getelementptr inbounds %struct.anon, %struct.anon* %s124, i32 0, i32 1, !dbg !531
  %34 = load i32, i32* %high125, align 4, !dbg !531
  %shr126 = lshr i32 %34, %inc, !dbg !532
  %s127 = bitcast %union.dwords* %r to %struct.anon*, !dbg !533
  %high128 = getelementptr inbounds %struct.anon, %struct.anon* %s127, i32 0, i32 1, !dbg !534
  store i32 %shr126, i32* %high128, align 4, !dbg !535
  %s129 = bitcast %union.dwords* %n to %struct.anon*, !dbg !536
  %high130 = getelementptr inbounds %struct.anon, %struct.anon* %s129, i32 0, i32 1, !dbg !537
...
if.else:                                          ; preds = %if.end23
  %s138 = bitcast %union.dwords* %d to %struct.anon*, !dbg !546
  %high139 = getelementptr inbounds %struct.anon, %struct.anon* %s138, i32 0, i32 1, !dbg !547
...
if.end168:                                        ; preds = %if.end161
  ...
  %s171 = bitcast %union.dwords* %n to %struct.anon*, !dbg !568
  %high172 = getelementptr inbounds %struct.anon, %struct.anon* %s171, i32 0, i32 1, !dbg !569
  %46 = load i32, i32* %high172, align 4, !dbg !569
  %shr173 = lshr i32 %46, %45, !dbg !570
  %s174 = bitcast %union.dwords* %q to %struct.anon*, !dbg !571
  %high175 = getelementptr inbounds %struct.anon, %struct.anon* %s174, i32 0, i32 1, !dbg !572
  store i32 %shr173, i32* %high175, align 4, !dbg !573
  %s176 = bitcast %union.dwords* %n to %struct.anon*, !dbg !574
  %high177 = getelementptr inbounds %struct.anon, %struct.anon* %s176, i32 0, i32 1, !dbg !575
...
if.end187:                                        ; preds = %if.then142
  ...
  %s190 = bitcast %union.dwords* %n to %struct.anon*, !dbg !588
  %high191 = getelementptr inbounds %struct.anon, %struct.anon* %s190, i32 0, i32 1, !dbg !589
...
if.then195:                                       ; preds = %if.end187
  ...
  %s200 = bitcast %union.dwords* %q to %struct.anon*, !dbg !597
  %high201 = getelementptr inbounds %struct.anon, %struct.anon* %s200, i32 0, i32 1, !dbg !598
  store i32 %54, i32* %high201, align 4, !dbg !599
  %s202 = bitcast %union.dwords* %r to %struct.anon*, !dbg !600
  %high203 = getelementptr inbounds %struct.anon, %struct.anon* %s202, i32 0, i32 1, !dbg !601
  store i32 0, i32* %high203, align 4, !dbg !602
  %s204 = bitcast %union.dwords* %n to %struct.anon*, !dbg !603
  %high205 = getelementptr inbounds %struct.anon, %struct.anon* %s204, i32 0, i32 1, !dbg !604
...
if.then211:                                       ; preds = %if.else208
  ...
  %s218 = bitcast %union.dwords* %q to %struct.anon*, !dbg !615
  %high219 = getelementptr inbounds %struct.anon, %struct.anon* %s218, i32 0, i32 1, !dbg !616
  store i32 %shl217, i32* %high219, align 4, !dbg !617
  %s220 = bitcast %union.dwords* %n to %struct.anon*, !dbg !618
  %high221 = getelementptr inbounds %struct.anon, %struct.anon* %s220, i32 0, i32 1, !dbg !619
  %57 = load i32, i32* %high221, align 4, !dbg !619
  %shr222 = lshr i32 %57, %sub192, !dbg !620
  %s223 = bitcast %union.dwords* %r to %struct.anon*, !dbg !621
  %high224 = getelementptr inbounds %struct.anon, %struct.anon* %s223, i32 0, i32 1, !dbg !622
  store i32 %shr222, i32* %high224, align 4, !dbg !623
  %s225 = bitcast %union.dwords* %n to %struct.anon*, !dbg !624
  %high226 = getelementptr inbounds %struct.anon, %struct.anon* %s225, i32 0, i32 1, !dbg !625
...
if.else235:                                       ; preds = %if.else208
  ...
  %s242 = bitcast %union.dwords* %n to %struct.anon*, !dbg !639
  %high243 = getelementptr inbounds %struct.anon, %struct.anon* %s242, i32 0, i32 1, !dbg !640
  ...
  %s251 = bitcast %union.dwords* %q to %struct.anon*, !dbg !647
  %high252 = getelementptr inbounds %struct.anon, %struct.anon* %s251, i32 0, i32 1, !dbg !648
  store i32 %or250, i32* %high252, align 4, !dbg !649
  %s253 = bitcast %union.dwords* %r to %struct.anon*, !dbg !650
  %high254 = getelementptr inbounds %struct.anon, %struct.anon* %s253, i32 0, i32 1, !dbg !651
  store i32 0, i32* %high254, align 4, !dbg !652
  %s255 = bitcast %union.dwords* %n to %struct.anon*, !dbg !653
  %high256 = getelementptr inbounds %struct.anon, %struct.anon* %s255, i32 0, i32 1, !dbg !654
...
if.else263:                                       ; preds = %if.else
  %s264 = bitcast %union.dwords* %d to %struct.anon*, !dbg !660
  %high265 = getelementptr inbounds %struct.anon, %struct.anon* %s264, i32 0, i32 1, !dbg !661
  %64 = load i32, i32* %high265, align 4, !dbg !661
  %65 = call i32 @llvm.ctlz.i32(i32 %64, i1 false), !dbg !662, !range !281
  %s266 = bitcast %union.dwords* %n to %struct.anon*, !dbg !663
  %high267 = getelementptr inbounds %struct.anon, %struct.anon* %s266, i32 0, i32 1, !dbg !664
...
if.then282:                                       ; preds = %if.end276
  ...
  %s285 = bitcast %union.dwords* %q to %struct.anon*, !dbg !680
  %high286 = getelementptr inbounds %struct.anon, %struct.anon* %s285, i32 0, i32 1, !dbg !681
  store i32 %69, i32* %high286, align 4, !dbg !682
  %s287 = bitcast %union.dwords* %r to %struct.anon*, !dbg !683
  %high288 = getelementptr inbounds %struct.anon, %struct.anon* %s287, i32 0, i32 1, !dbg !684
  store i32 0, i32* %high288, align 4, !dbg !685
  %s289 = bitcast %union.dwords* %n to %struct.anon*, !dbg !686
  %high290 = getelementptr inbounds %struct.anon, %struct.anon* %s289, i32 0, i32 1, !dbg !687
...
if.else293:                                       ; preds = %if.end276
  ...
  %s298 = bitcast %union.dwords* %q to %struct.anon*, !dbg !694
  %high299 = getelementptr inbounds %struct.anon, %struct.anon* %s298, i32 0, i32 1, !dbg !695
  store i32 %shl297, i32* %high299, align 4, !dbg !696
  %s300 = bitcast %union.dwords* %n to %struct.anon*, !dbg !697
  %high301 = getelementptr inbounds %struct.anon, %struct.anon* %s300, i32 0, i32 1, !dbg !698
  %72 = load i32, i32* %high301, align 4, !dbg !698
  %shr302 = lshr i32 %72, %inc277, !dbg !699
  %s303 = bitcast %union.dwords* %r to %struct.anon*, !dbg !700
  %high304 = getelementptr inbounds %struct.anon, %struct.anon* %s303, i32 0, i32 1, !dbg !701
  store i32 %shr302, i32* %high304, align 4, !dbg !702
  %s305 = bitcast %union.dwords* %n to %struct.anon*, !dbg !703
  %high306 = getelementptr inbounds %struct.anon, %struct.anon* %s305, i32 0, i32 1, !dbg !704
...
for.body:                                         ; preds = %for.cond
  %s320 = bitcast %union.dwords* %r to %struct.anon*, !dbg !715
  %high321 = getelementptr inbounds %struct.anon, %struct.anon* %s320, i32 0, i32 1, !dbg !716
  ...
  %s327 = bitcast %union.dwords* %r to %struct.anon*, !dbg !719
  %high328 = getelementptr inbounds %struct.anon, %struct.anon* %s327, i32 0, i32 1, !dbg !720
  store i32 %or326, i32* %high328, align 4, !dbg !721
  %s332 = bitcast %union.dwords* %q to %struct.anon*, !dbg !722
  %high333 = getelementptr inbounds %struct.anon, %struct.anon* %s332, i32 0, i32 1, !dbg !723
  ...
  %s338 = bitcast %union.dwords* %q to %struct.anon*, !dbg !727
  %high339 = getelementptr inbounds %struct.anon, %struct.anon* %s338, i32 0, i32 1, !dbg !728
  ...
  %s345 = bitcast %union.dwords* %q to %struct.anon*, !dbg !731
  %high346 = getelementptr inbounds %struct.anon, %struct.anon* %s345, i32 0, i32 1, !dbg !732
...
if.then:                                          ; preds = %entry
  %s1 = bitcast %union.dwords* %x to %struct.anon*, !dbg !792
  %high = getelementptr inbounds %struct.anon, %struct.anon* %s1, i32 0, i32 1, !dbg !793
...
if.end:                                           ; preds = %if.then
  %s4 = bitcast %union.dwords* %x to %struct.anon*, !dbg !797
  %high5 = getelementptr inbounds %struct.anon, %struct.anon* %s4, i32 0, i32 1, !dbg !798
...
if.then:                                          ; preds = %entry
  %s = bitcast %union.dwords* %result to %struct.anon*, !dbg !822
  %high = getelementptr inbounds %struct.anon, %struct.anon* %s, i32 0, i32 1, !dbg !823
  store i32 0, i32* %high, align 4, !dbg !824
  %s1 = bitcast %union.dwords* %input to %struct.anon*, !dbg !825
  %high2 = getelementptr inbounds %struct.anon, %struct.anon* %s1, i32 0, i32 1, !dbg !826
...
if.end:                                           ; preds = %if.else
  %s5 = bitcast %union.dwords* %input to %struct.anon*, !dbg !835
  %high6 = getelementptr inbounds %struct.anon, %struct.anon* %s5, i32 0, i32 1, !dbg !836
  %1 = load i32, i32* %high6, align 4, !dbg !836
  %shr7 = lshr i32 %1, %b, !dbg !837
  %s8 = bitcast %union.dwords* %result to %struct.anon*, !dbg !838
  %high9 = getelementptr inbounds %struct.anon, %struct.anon* %s8, i32 0, i32 1, !dbg !839
  store i32 %shr7, i32* %high9, align 4, !dbg !840
  %s10 = bitcast %union.dwords* %input to %struct.anon*, !dbg !841
  %high11 = getelementptr inbounds %struct.anon, %struct.anon* %s10, i32 0, i32 1, !dbg !842
...
entry:
  ...
  %s = bitcast %union.dwords* %x to %struct.anon*, !dbg !958
  %high = getelementptr inbounds %struct.anon, %struct.anon* %s, i32 0, i32 1, !dbg !959
...
entry:
  ...
  %s = bitcast %union.dwords* %x to %struct.anon*, !dbg !1041
  %high = getelementptr inbounds %struct.anon, %struct.anon* %s, i32 0, i32 1, !dbg !1042
  %0 = load i32, i32* %high, align 4, !dbg !1042
  %s2 = bitcast %union.dwords* %y to %struct.anon*, !dbg !1043
  %high3 = getelementptr inbounds %struct.anon, %struct.anon* %s2, i32 0, i32 1, !dbg !1044
...
if.end:                                           ; preds = %entry
  %s4 = bitcast %union.dwords* %x to %struct.anon*, !dbg !1048
  %high5 = getelementptr inbounds %struct.anon, %struct.anon* %s4, i32 0, i32 1, !dbg !1049
  %2 = load i32, i32* %high5, align 4, !dbg !1049
  %s6 = bitcast %union.dwords* %y to %struct.anon*, !dbg !1050
  %high7 = getelementptr inbounds %struct.anon, %struct.anon* %s6, i32 0, i32 1, !dbg !1051
...
!125 = distinct !DISubprogram(name: "rad2deg_init", scope: !126, file: !126, line: 45, type: !127, scopeLine: 45, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !128)
!126 = !DIFile(filename: "batchtest/rad2deg/rad2deg.c", directory: "/workspaces/llvmta/testcases", checksumkind: CSK_MD5, checksum: "4caa21133271f14cd04f199ea1dac6c5")
!127 = !DISubroutineType(types: !128)
!128 = !{}
!129 = !DILocation(line: 46, column: 13, scope: !125)
!130 = !DILocation(line: 47, column: 13, scope: !125)
!131 = !DILocation(line: 48, column: 1, scope: !125)
!132 = distinct !DISubprogram(name: "rad2deg_return", scope: !126, file: !126, line: 54, type: !127, scopeLine: 54, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !128)
!133 = !DILocation(line: 55, column: 14, scope: !132)
!134 = !DILocation(line: 57, column: 12, scope: !132)
!135 = !DILocation(line: 57, column: 7, scope: !132)
!136 = !DILocation(line: 58, column: 5, scope: !132)
!137 = !DILocation(line: 60, column: 5, scope: !132)
!138 = !DILocation(line: 0, scope: !132)
!139 = !DILocation(line: 61, column: 1, scope: !132)
!140 = distinct !DISubprogram(name: "rad2deg_main", scope: !126, file: !126, line: 67, type: !127, scopeLine: 67, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !128)
!141 = !DILocation(line: 68, column: 45, scope: !140)
!142 = !DILocation(line: 0, scope: !140)
!143 = !DILocation(line: 69, column: 55, scope: !140)
!144 = !DILocation(line: 68, column: 40, scope: !140)
!145 = !DILocation(line: 71, column: 20, scope: !140)
!146 = !DILocation(line: 71, column: 17, scope: !140)
!147 = !DILocation(line: 71, column: 7, scope: !140)
!148 = !DILocation(line: 70, column: 55, scope: !140)
!149 = distinct !{!149, !144, !145, !150}
!150 = !{!"llvm.loop.mustprogress"}
!151 = !DILocation(line: 72, column: 1, scope: !140)
!152 = distinct !DISubprogram(name: "main", scope: !126, file: !126, line: 74, type: !127, scopeLine: 74, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !128)
!153 = !DILocation(line: 75, column: 3, scope: !152)
!154 = !DILocation(line: 76, column: 3, scope: !152)
!155 = !DILocation(line: 77, column: 10, scope: !152)
!156 = !DILocation(line: 77, column: 3, scope: !152)
!157 = distinct !DISubprogram(name: "__absvdi2", scope: !3, file: !3, line: 22, type: !127, scopeLine: 23, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !128)
!158 = !DILocation(line: 25, column: 11, scope: !157)
!159 = !DILocation(line: 25, column: 9, scope: !157)
!160 = !DILocation(line: 26, column: 9, scope: !157)
!161 = !DILocation(line: 28, column: 20, scope: !157)
!162 = !DILocation(line: 28, column: 5, scope: !157)
!163 = distinct !DISubprogram(name: "compilerrt_abort_impl", scope: !55, file: !55, line: 57, type: !127, scopeLine: 57, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !54, retainedNodes: !128)
!164 = !DILocation(line: 59, column: 1, scope: !163)
!165 = distinct !DISubprogram(name: "__absvsi2", scope: !5, file: !5, line: 22, type: !127, scopeLine: 23, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !4, retainedNodes: !128)
...
!171 = distinct !DISubprogram(name: "__addvdi3", scope: !9, file: !9, line: 22, type: !127, scopeLine: 23, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !8, retainedNodes: !128)
...
!183 = distinct !DISubprogram(name: "__addvsi3", scope: !11, file: !11, line: 22, type: !127, scopeLine: 23, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !10, retainedNodes: !128)
...
!195 = distinct !DISubprogram(name: "__ashldi3", scope: !15, file: !15, line: 24, type: !127, scopeLine: 25, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !14, retainedNodes: !128)
...
!230 = distinct !DISubprogram(name: "__ashrdi3", scope: !19, file: !19, line: 24, type: !127, scopeLine: 25, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !18, retainedNodes: !128)
...
!270 = distinct !DISubprogram(name: "__clzdi2", scope: !23, file: !23, line: 22, type: !127, scopeLine: 23, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !22, retainedNodes: !128)
...
!285 = distinct !DISubprogram(name: "__clzsi2", scope: !25, file: !25, line: 22, type: !127, scopeLine: 23, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !24, retainedNodes: !128)
...
!313 = distinct !DISubprogram(name: "__cmpdi2", scope: !29, file: !29, line: 23, type: !127, scopeLine: 24, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !28, retainedNodes: !128)
...
!345 = distinct !DISubprogram(name: "__aeabi_lcmp", scope: !29, file: !29, line: 46, type: !127, scopeLine: 47, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !28, retainedNodes: !128)
...
!349 = distinct !DISubprogram(name: "__ctzdi2", scope: !33, file: !33, line: 22, type: !127, scopeLine: 23, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !32, retainedNodes: !128)
...
!361 = distinct !DISubprogram(name: "__ctzsi2", scope: !35, file: !35, line: 22, type: !127, scopeLine: 23, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !34, retainedNodes: !128)
...
!387 = distinct !DISubprogram(name: "__divdi3", scope: !39, file: !39, line: 20, type: !127, scopeLine: 21, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !38, retainedNodes: !128)
...
!399 = distinct !DISubprogram(name: "__udivmoddi4", scope: !97, file: !97, line: 24, type: !127, scopeLine: 25, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !96, retainedNodes: !128)
...
!762 = distinct !DISubprogram(name: "__divmoddi4", scope: !41, file: !41, line: 20, type: !127, scopeLine: 21, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !40, retainedNodes: !128)
...
!768 = distinct !DISubprogram(name: "__divmodsi4", scope: !43, file: !43, line: 20, type: !127, scopeLine: 21, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !42, retainedNodes: !128)
...
!774 = distinct !DISubprogram(name: "__divsi3", scope: !45, file: !45, line: 22, type: !127, scopeLine: 23, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !44, retainedNodes: !128)
...
!786 = distinct !DISubprogram(name: "__ffsdi2", scope: !49, file: !49, line: 22, type: !127, scopeLine: 23, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !48, retainedNodes: !128)
...
!808 = distinct !DISubprogram(name: "__ffssi2", scope: !51, file: !51, line: 22, type: !127, scopeLine: 23, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !50, retainedNodes: !128)
...
!817 = distinct !DISubprogram(name: "__lshrdi3", scope: !57, file: !57, line: 24, type: !127, scopeLine: 25, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !56, retainedNodes: !128)
...
!854 = distinct !DISubprogram(name: "__moddi3", scope: !61, file: !61, line: 20, type: !127, scopeLine: 21, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !60, retainedNodes: !128)
...
!864 = distinct !DISubprogram(name: "__modsi3", scope: !63, file: !63, line: 20, type: !127, scopeLine: 21, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !62, retainedNodes: !128)
...
!869 = distinct !DISubprogram(name: "__mulvdi3", scope: !67, file: !67, line: 22, type: !127, scopeLine: 23, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !66, retainedNodes: !128)
...
!912 = distinct !DISubprogram(name: "__mulvsi3", scope: !69, file: !69, line: 22, type: !127, scopeLine: 23, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !68, retainedNodes: !128)
...
!955 = distinct !DISubprogram(name: "__paritydi2", scope: !73, file: !73, line: 20, type: !127, scopeLine: 21, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !72, retainedNodes: !128)
...
!964 = distinct !DISubprogram(name: "__paritysi2", scope: !75, file: !75, line: 20, type: !127, scopeLine: 21, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !74, retainedNodes: !128)
...
!975 = distinct !DISubprogram(name: "__popcountdi2", scope: !79, file: !79, line: 20, type: !127, scopeLine: 21, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !78, retainedNodes: !128)
...
!995 = distinct !DISubprogram(name: "__popcountsi2", scope: !81, file: !81, line: 20, type: !127, scopeLine: 21, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !80, retainedNodes: !128)
...
!1012 = distinct !DISubprogram(name: "__subvdi3", scope: !85, file: !85, line: 22, type: !127, scopeLine: 23, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !84, retainedNodes: !128)
...
!1024 = distinct !DISubprogram(name: "__subvsi3", scope: !87, file: !87, line: 22, type: !127, scopeLine: 23, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !86, retainedNodes: !128)
...
!1036 = distinct !DISubprogram(name: "__ucmpdi2", scope: !91, file: !91, line: 23, type: !127, scopeLine: 24, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !90, retainedNodes: !128)
...
!1068 = distinct !DISubprogram(name: "__aeabi_ulcmp", scope: !91, file: !91, line: 46, type: !127, scopeLine: 47, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !90, retainedNodes: !128)
...
!1072 = distinct !DISubprogram(name: "__udivdi3", scope: !95, file: !95, line: 20, type: !127, scopeLine: 21, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !94, retainedNodes: !128)
!1073 = !DILocation(line: 22, column: 12, scope: !1072)
!1074 = !DILocation(line: 22, column: 5, scope: !1072)
!1075 = distinct !DISubprogram(name: "__udivmodsi4", scope: !99, file: !99, line: 20, type: !127, scopeLine: 21, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !98, retainedNodes: !128)
...
!1081 = distinct !DISubprogram(name: "__udivsi3", scope: !103, file: !103, line: 25, type: !127, scopeLine: 26, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !102, retainedNodes: !128)
...
!1113 = distinct !{!1113, !1101, !1106, !150}
...
!1118 = distinct !DISubprogram(name: "__umoddi3", scope: !107, file: !107, line: 20, type: !127, scopeLine: 21, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !106, retainedNodes: !128)
...
!1122 = distinct !DISubprogram(name: "__umodsi3", scope: !109, file: !109, line: 20, type: !127, scopeLine: 21, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !108, retainedNodes: !128)
...
!1127 = distinct !DISubprogram(name: "memcpy", scope: !113, file: !113, line: 3, type: !127, scopeLine: 4, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !112, retainedNodes: !128)
...
!1137 = distinct !{!1137, !1131, !1135, !150}
!1138 = !DILocation(line: 11, column: 1, scope: !1127)
!1139 = distinct !DISubprogram(name: "memset", scope: !113, file: !113, line: 13, type: !127, scopeLine: 14, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !112, retainedNodes: !128)
...
!1149 = distinct !{!1149, !1143, !1147, !150}
