...
cover_init:
.Lfunc_begin0:
	.file	1 "/workspaces/llvmta/testcases" "batchtest/cover/cover.c" md5 0xb20439d968218da77f6a9051b6098546
	.loc	1 49 0                          @ batchtest/cover/cover.c:49:0
	.fnstart
	.cfi_sections .debug_frame
	.cfi_startproc
@ %bb.0:                                @ %entry
	.loc	1 50 13 prologue_end            @ batchtest/cover/cover.c:50:13
	ldr	r1, .LCPI0_0
	mov	r0, #0
	str	r0, [r1]
	.loc	1 51 1                          @ batchtest/cover/cover.c:51:1
	bx	lr
.Ltmp0:
	.p2align	2
@ %bb.1:
	.loc	1 0 1 is_stmt 0                 @ batchtest/cover/cover.c:0:1
.LCPI0_0:
	.long	cover_cnt
.Lfunc_end0:
...
cover_return:
.Lfunc_begin1:
	.loc	1 55 0 is_stmt 1                @ batchtest/cover/cover.c:55:0
	.fnstart
	.cfi_startproc
@ %bb.0:                                @ %entry
	.loc	1 56 10 prologue_end            @ batchtest/cover/cover.c:56:10
	ldr	r0, .LCPI1_0
	ldr	r0, [r0]
	.loc	1 56 20 is_stmt 0               @ batchtest/cover/cover.c:56:20
	sub	r0, r0, #180
	.loc	1 56 3                          @ batchtest/cover/cover.c:56:3
	bx	lr
.Ltmp1:
	.p2align	2
@ %bb.1:
	.loc	1 0 3                           @ batchtest/cover/cover.c:0:3
.LCPI1_0:
	.long	cover_cnt
.Lfunc_end1:
	...
	.fnend
                                        @ -- End function
	.globl	increment_c                     @ -- Begin function increment_c
	.p2align	2
	.type	increment_c,%function
	.code	32                              @ @increment_c
increment_c:
.Lfunc_begin2:
	.loc	1 60 0 is_stmt 1                @ batchtest/cover/cover.c:60:0
	.fnstart
	.cfi_startproc
@ %bb.0:                                @ %entry
	.loc	1 61 4 prologue_end             @ batchtest/cover/cover.c:61:4
	add	r0, r0, #1
	.loc	1 62 3                          @ batchtest/cover/cover.c:62:3
	bx	lr
.Ltmp2:
.Lfunc_end2:
	.size	increment_c, .Lfunc_end2-increment_c
	.cfi_endproc
	.cantunwind
	.fnend
                                        @ -- End function
...
cover_swi120:
.Lfunc_begin3:
	.loc	1 69 0                          @ batchtest/cover/cover.c:69:0
	.fnstart
	.cfi_startproc
@ %bb.0:                                @ %entry
	push	{r11, lr}
...
.Ltmp3:
	.loc	1 72 8 prologue_end             @ batchtest/cover/cover.c:72:8
	b	.LBB3_1
.LBB3_1:                                @ %for.cond
                                        @ =>This Inner Loop Header: Depth=1
	.loc	1 0 8 is_stmt 0                 @ batchtest/cover/cover.c:0:8
	ldr	r0, [r11, #-8]                  @ 4-byte Reload
	ldr	r1, [r11, #-4]                  @ 4-byte Reload
	str	r1, [sp, #8]                    @ 4-byte Spill
	str	r0, [sp, #12]                   @ 4-byte Spill
	.loc	1 72 3                          @ batchtest/cover/cover.c:72:3
	cmp	r0, #1
	beq	.LBB3_4
	b	.LBB3_2
.LBB3_2:                                @ %for.body
                                        @   in Loop: Header=BB3_1 Depth=1
	.loc	1 73 11 is_stmt 1               @ batchtest/cover/cover.c:73:11
	ldr	r0, [sp, #8]                    @ 4-byte Reload
	bl	increment_c
	str	r0, [sp, #4]                    @ 4-byte Spill
	.loc	1 74 3                          @ batchtest/cover/cover.c:74:3
	b	.LBB3_3
.LBB3_3:                                @ %for.inc
                                        @   in Loop: Header=BB3_1 Depth=1
	.loc	1 72 23                         @ batchtest/cover/cover.c:72:23
	ldr	r0, [sp, #4]                    @ 4-byte Reload
	ldr	r1, [sp, #12]                   @ 4-byte Reload
	add	r1, r1, #1
	str	r1, [r11, #-8]                  @ 4-byte Spill
	str	r0, [r11, #-4]                  @ 4-byte Spill
	.loc	1 72 3 is_stmt 0                @ batchtest/cover/cover.c:72:3
	b	.LBB3_1
.LBB3_4:                                @ %for.end
	.loc	1 75 3 is_stmt 1                @ batchtest/cover/cover.c:75:3
	ldr	r0, [sp, #8]                    @ 4-byte Reload
	mov	sp, r11
	pop	{r11, lr}
	bx	lr
.Ltmp4:
.Lfunc_end3:
	.size	cover_swi120, .Lfunc_end3-cover_swi120
	.cfi_endproc
	.cantunwind
	.fnend
                                        @ -- End function
...
cover_swi50:
.Lfunc_begin4:
	.loc	1 79 0                          @ batchtest/cover/cover.c:79:0
	.fnstart
	.cfi_startproc
@ %bb.0:                                @ %entry
	push	{r11, lr}
	...
	str	r0, [r11, #-4]                  @ 4-byte Spill
.Ltmp5:
	.loc	1 82 8 prologue_end             @ batchtest/cover/cover.c:82:8
	b	.LBB4_1
.LBB4_1:                                @ %for.cond
                                        @ =>This Inner Loop Header: Depth=1
	.loc	1 0 8 is_stmt 0                 @ batchtest/cover/cover.c:0:8
	...
	str	r1, [sp, #8]                    @ 4-byte Spill
	str	r0, [sp, #12]                   @ 4-byte Spill
	.loc	1 82 3                          @ batchtest/cover/cover.c:82:3
	cmp	r0, #1
	beq	.LBB4_4
	b	.LBB4_2
.LBB4_2:                                @ %for.body
                                        @   in Loop: Header=BB4_1 Depth=1
	.loc	1 83 11 is_stmt 1               @ batchtest/cover/cover.c:83:11
	ldr	r0, [sp, #8]                    @ 4-byte Reload
	bl	increment_c
	str	r0, [sp, #4]                    @ 4-byte Spill
	.loc	1 84 3                          @ batchtest/cover/cover.c:84:3
	b	.LBB4_3
.LBB4_3:                                @ %for.inc
                                        @   in Loop: Header=BB4_1 Depth=1
	.loc	1 82 23                         @ batchtest/cover/cover.c:82:23
	ldr	r0, [sp, #4]                    @ 4-byte Reload
	ldr	r1, [sp, #12]                   @ 4-byte Reload
	add	r1, r1, #1
	str	r1, [r11, #-8]                  @ 4-byte Spill
	str	r0, [r11, #-4]                  @ 4-byte Spill
	.loc	1 82 3 is_stmt 0                @ batchtest/cover/cover.c:82:3
	b	.LBB4_1
.LBB4_4:                                @ %for.end
	.loc	1 85 3 is_stmt 1                @ batchtest/cover/cover.c:85:3
	ldr	r0, [sp, #8]                    @ 4-byte Reload
	mov	sp, r11
	pop	{r11, lr}
	bx	lr
.Ltmp6:
.Lfunc_end4:
	.size	cover_swi50, .Lfunc_end4-cover_swi50
	.cfi_endproc
	.cantunwind
	.fnend
                                        @ -- End function
...
cover_swi10:
.Lfunc_begin5:
	.loc	1 91 0                          @ batchtest/cover/cover.c:91:0
	.fnstart
	.cfi_startproc
@ %bb.0:                                @ %entry
	push	{r11, lr}
	...
	str	r0, [r11, #-4]                  @ 4-byte Spill
.Ltmp7:
	.loc	1 94 8 prologue_end             @ batchtest/cover/cover.c:94:8
	b	.LBB5_1
.LBB5_1:                                @ %for.cond
                                        @ =>This Inner Loop Header: Depth=1
	.loc	1 0 8 is_stmt 0                 @ batchtest/cover/cover.c:0:8
	...
	str	r1, [sp, #8]                    @ 4-byte Spill
	str	r0, [sp, #12]                   @ 4-byte Spill
	.loc	1 94 3                          @ batchtest/cover/cover.c:94:3
	cmp	r0, #1
	beq	.LBB5_4
	b	.LBB5_2
.LBB5_2:                                @ %for.body
                                        @   in Loop: Header=BB5_1 Depth=1
	.loc	1 95 11 is_stmt 1               @ batchtest/cover/cover.c:95:11
	ldr	r0, [sp, #8]                    @ 4-byte Reload
	bl	increment_c
	str	r0, [sp, #4]                    @ 4-byte Spill
	.loc	1 96 3                          @ batchtest/cover/cover.c:96:3
	b	.LBB5_3
.LBB5_3:                                @ %for.inc
                                        @   in Loop: Header=BB5_1 Depth=1
	.loc	1 94 23                         @ batchtest/cover/cover.c:94:23
	ldr	r0, [sp, #4]                    @ 4-byte Reload
	ldr	r1, [sp, #12]                   @ 4-byte Reload
	add	r1, r1, #1
	str	r1, [r11, #-8]                  @ 4-byte Spill
	str	r0, [r11, #-4]                  @ 4-byte Spill
	.loc	1 94 3 is_stmt 0                @ batchtest/cover/cover.c:94:3
	b	.LBB5_1
.LBB5_4:                                @ %for.end
	.loc	1 97 3 is_stmt 1                @ batchtest/cover/cover.c:97:3
	ldr	r0, [sp, #8]                    @ 4-byte Reload
	mov	sp, r11
	pop	{r11, lr}
	bx	lr
.Ltmp8:
.Lfunc_end5:
	.size	cover_swi10, .Lfunc_end5-cover_swi10
	.cfi_endproc
	.cantunwind
	.fnend
                                        @ -- End function
...
cover_main:
.Lfunc_begin6:
	.loc	1 102 0                         @ batchtest/cover/cover.c:102:0
	.fnstart
	.cfi_startproc
@ %bb.0:                                @ %entry
	push	{r11, lr}
	...
	sub	sp, sp, #8
.Ltmp9:
	.loc	1 103 28 prologue_end           @ batchtest/cover/cover.c:103:28
	ldr	r0, .LCPI6_0
	str	r0, [sp, #4]                    @ 4-byte Spill
	ldr	r0, [r0]
	.loc	1 103 15 is_stmt 0              @ batchtest/cover/cover.c:103:15
	bl	cover_swi10
	mov	r1, r0
	.loc	1 103 13                        @ batchtest/cover/cover.c:103:13
	ldr	r0, [sp, #4]                    @ 4-byte Reload
	str	r1, [r0]
	.loc	1 105 28 is_stmt 1              @ batchtest/cover/cover.c:105:28
	ldr	r0, [r0]
	.loc	1 105 15 is_stmt 0              @ batchtest/cover/cover.c:105:15
	bl	cover_swi50
	mov	r1, r0
	.loc	1 105 13                        @ batchtest/cover/cover.c:105:13
	ldr	r0, [sp, #4]                    @ 4-byte Reload
	str	r1, [r0]
	.loc	1 107 29 is_stmt 1              @ batchtest/cover/cover.c:107:29
	ldr	r0, [r0]
	.loc	1 107 15 is_stmt 0              @ batchtest/cover/cover.c:107:15
	bl	cover_swi120
	ldr	r1, [sp, #4]                    @ 4-byte Reload
	.loc	1 107 13                        @ batchtest/cover/cover.c:107:13
	str	r0, [r1]
	.loc	1 108 1 is_stmt 1               @ batchtest/cover/cover.c:108:1
	mov	sp, r11
	pop	{r11, lr}
	bx	lr
.Ltmp10:
...
.LCPI6_0:
	.long	cover_cnt
.Lfunc_end6:
	.size	cover_main, .Lfunc_end6-cover_main
	.cfi_endproc
	.cantunwind
	.fnend
                                        @ -- End function
...
main:
.Lfunc_begin7:
	.loc	1 116 0 is_stmt 1               @ batchtest/cover/cover.c:116:0
	.fnstart
	.cfi_startproc
@ %bb.0:                                @ %entry
	push	{r11, lr}
	...
	.cfi_def_cfa_register r11
.Ltmp11:
	.loc	1 117 3 prologue_end            @ batchtest/cover/cover.c:117:3
	bl	cover_init
	.loc	1 118 3                         @ batchtest/cover/cover.c:118:3
	bl	cover_main
	.loc	1 120 10                        @ batchtest/cover/cover.c:120:10
	bl	cover_return
	.loc	1 120 3 is_stmt 0               @ batchtest/cover/cover.c:120:3
	pop	{r11, lr}
	bx	lr
.Ltmp12:
.Lfunc_end7:
...
.Linfo_string1:
	.asciz	"/workspaces/llvmta/testcases/batchtest/cover/cover.c" @ string offset=100
.Linfo_string2:
	.asciz	"/workspaces/llvmta/testcases/tmp.3MTEHdKd5Y" @ string offset=153
.Linfo_string3:
